 ...
 */
/******************************************************************************/
void Os_InitTrace(void)
{
    Os_CoreIdType      coreId   = Os_SCB.sysCore;
    Os_AppObjectIDType objectId = 0u;
 ...
 */
/******************************************************************************/
void Os_TraceLastError(StatusType error)
{
 ...
 */
/******************************************************************************/
void Os_TraceTaskStart(Os_TaskType taskId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceTaskRun(Os_TaskType taskId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceTaskActive(Os_TaskType taskId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceTaskTerminate(Os_TaskType taskId, Os_TraceTaskSwitchReasonType termReason)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceIsrEnter(Os_IsrType isrId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceIsrExit(Os_IsrType isrId, Os_IsrType nestIsrId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceServiceEnter(Os_ServiceIdType serviceId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceServiceExit(Os_ServiceIdType serviceId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceResourceIsrGet(Os_ResourceType resourceId, Os_IsrType isrId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceResourceTaskGet(Os_ResourceType resourceId, Os_TaskType taskId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceResourceRelease(Os_ResourceType resourceId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceAlarmStart(Os_AlarmType alarmId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
 ...
 */
/******************************************************************************/
void Os_TraceAlarmStop(Os_AlarmType alarmId)
{
    if (NULL_PTR != Os_SCB.trace)
    {
        Os_CoreIdType coreId = Os_SCB.sysCore;
