...
static Os_StackAndCheckedSpaceStatus Os_StackAndCheckedSpace(
...
static StatusType Os_CheckAddrNotInStackSpace(AccessRefType Access, MemoryStartAddressType Address, MemorySizeType Size)
/* PRQA S 3450 -- */
{
...
static AccessType Os_CheckISR2Access(ISRType ISRID, MemoryStartAddressType Address, MemorySizeType Size)
 ...
 */
/******************************************************************************/
AccessType Os_CheckISRMemoryAccess(ISRType ISRID, MemoryStartAddressType Address, MemorySizeType Size)
{
    AccessType Access = (AccessType)NO_PERMISSION;
...
/******************************************************************************/
/* PRQA S 6030, 6010, 3450 ++ */ /* VL_MTR_Os_STMIF, VL_MTR_Os_STCYC, VL_Os_3450 */
static AccessType Os_CheckTaskAccess(TaskType TaskID, MemoryStartAddressType Address, MemorySizeType Size)
/* PRQA S 6030, 6010, 3450 -- */
{
 ...
 */
/******************************************************************************/
AccessType Os_CheckTaskMemoryAccess(TaskType TaskID, MemoryStartAddressType Address, MemorySizeType Size)
{
    AccessType Access = (AccessType)NO_PERMISSION;
    OS_ARCH_DECLARE_CRITICAL();
