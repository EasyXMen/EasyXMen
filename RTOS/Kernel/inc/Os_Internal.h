...
#define OS_EXTERN
#else
#define OS_EXTERN extern /* PRQA S 3414 */ /* VL_QAC_KeyWord */
#endif
...
/*============================@+SPINLOCK+@====================================*/
/* PRQA S 3406 ++ */ /* VL_Os_3406 */
#if (OS_AUTOSAR_CORES > 1U)
#define OS_START_SEC_VAR_CLEARED_GLOBAL_32
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_SpinlockType Os_SpinlockSync);
...
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint16 Os_CfgPriorityMax);
...
OS_EXTERN OS_KNL_BSS(Os_PriorityType* Os_ReadyMap);
/* PRQA S 1531 -- */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_TaskType* Os_ReadyTable);
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
#else
#define OS_START_SEC_VAR_CLONE_UNSPECIFIED
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_ReadyQueueType* Os_ReadyQueueMark); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_UNSPECIFIED
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_32
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const uint32* Os_ActivateQueueSize); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_32
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_TaskRefType* Os_ReadyQueue); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
...
#include "Os_MemMap.h"
/* PRQA S 1531 ++ */ /* VL_QAC_OneRefSymbol */
OS_EXTERN OS_KNL_BSS(const Os_PriorityType* Os_PrioGroup);
/* PRQA S 1531 -- */
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
...
#include "Os_MemMap.h"
/* PRQA S 1531 ++ */ /* VL_QAC_OneRefSymbol */
OS_EXTERN OS_KNL_BSS(const Os_PriorityType* Os_PrioMask);
/* PRQA S 1531 -- */
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_StackType* Os_SystemStack); /* PRQA S 1533 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
/*===============================@-KERNEL-@===================================*/
...
#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_TaskCfgType* Os_TaskCfg);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_StackType* Os_TaskStack);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_TCBType* Os_TCB);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint16 OS_TASK_IDLE); /* PRQA S 1533 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint16 Os_CfgExtendTaskMax); /* PRQA S 1751, 1502 */ /* VL_Os_1751, VL_Os_1502 */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint16 Os_CfgIsrMax); /* PRQA S 1531, 1502 */ /* VL_QAC_OneRefSymbol, VL_Os_1502 */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint16 Os_CfgIsr2Max); /* PRQA S 1533 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_ICBType* Os_ICB);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_StackType* Os_ISR2Stack);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_IsrCfgType* Os_IsrCfg);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_IsrType Os_IntCfgIsrId);
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
...
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint8 Os_SuspendAllCount); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_8
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_8
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint8 Os_SuspendOsCount); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_8
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_IPLType Os_SaveOsIntNested); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_32
#include "Os_MemMap.h"
/* PRQA S 1531, 1751 ++ */ /* VL_QAC_OneRefSymbol */
/* PRQA S 1533 ++ */ /* VL_Os_1533 */
OS_EXTERN OS_KNL_BSS(uint8 Os_IntNestISR1);
/* PRQA S 1533 -- */
/* PRQA S 1531, 1751 -- */
#define OS_STOP_SEC_VAR_CLONE_32
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_32
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint8 Os_IntNestISR2);
#define OS_STOP_SEC_VAR_CLONE_32
#include "Os_MemMap.h"
/*===============================@-ISR-@======================================*/
...
#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_CounterCfgType* Os_CounterCfg);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_CCBType* Os_CCB);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_ResourceCfgType* Os_ResourceCfg); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_RCBType* Os_RCB); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"

#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(uint16 Os_CfgResourceMax); /* PRQA S 1531 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_PriorityType* Os_InterResCeiling);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(Os_ResourceType RES_SCHEDULER); /* PRQA S 1533 */ /* VL_QAC_OneRefSymbol */
#define OS_STOP_SEC_VAR_CLONE_16
#include "Os_MemMap.h"
#endif /* CFG_STD_RESOURCE_MAX > 0U */
/*===============================@-RESOURCE-@=================================*/
...
#define OS_START_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
OS_EXTERN OS_KNL_BSS(const Os_ObjectAppCfgType** Os_ObjectAppCfg);
#define OS_STOP_SEC_VAR_CLONE_PTR
#include "Os_MemMap.h"
/* PRQA S 3406 -- */
 ...
 */
/********************************************************************/
extern void Os_CallPreTaskHook(void);
 ...
 */
/******************************************************************************/
extern void Os_CallPostTaskHook(void);
 ...
 */
/******************************************************************************/
extern void Os_CallShutdownHook(StatusType Error);
 ...
 */
/******************************************************************************/
extern void Os_CallStartupHook(void);
 ...
 */
/********************************************************************/
extern ProtectionReturnType Os_CallProtectionHook(StatusType osErrType, uint32 osWhoHook);
 ...
 */
/******************************************************************************/
extern void Os_ApplShutdownHook(StatusType Fatalerror);
 ...
 */
/******************************************************************************/
extern void Os_ApplStartupHook(void);
 ...
 */
/******************************************************************************/
extern void Os_TerminateApplication(ApplicationType Application, RestartType RestartOption);
#endif /* OS_SC3 == CFG_SC || OS_SC4 == CFG_SC */
/*============================ @-APPLICATION-@================================*/
 ...
 */
/******************************************************************************/
extern void Os_GetInternalResource(void); /* PRQA S 1753 */ /* VL_Os_1753 */
 ...
 */
/******************************************************************************/
extern void Os_InitSpinlock(void);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern StatusType Os_SpinlockSafetyCheck(void);
 ...
 */
/******************************************************************************/
extern void Os_ReleaseSpinlock(SpinlockIdType SpinlockId);
 ...
 */
/******************************************************************************/
extern void Os_SwitchTask(void);
/******************************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_ClearPrioReadyMap(Os_PriorityType OsPrio);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern Os_PriorityType Os_GetHighPrio(void);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern Os_TaskType Os_ReadyQueueGetFirst(Os_PriorityType prio);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern void Os_ReadyQueueInsert(Os_TaskType object, Os_CallLevelType level, Os_PriorityType prio);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern void Os_ReadyQueueRemove(Os_CallLevelType level, Os_PriorityType prio);
 ...
 */
/******************************************************************************/
extern Os_IPLType Os_PrioToIpl(Os_PriorityType prio);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern Os_PriorityType Os_IplToPrio(Os_IPLType ipl);
/*============================ @-Interrupt-@==========================*/
 ...
 */
/******************************************************************************/
extern Os_TickType Os_CalcAbsTicks(Os_TickType baseTick, Os_TickType offset, Os_CounterType CounterID);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern Os_TickType Os_GetDistance(Os_TickType baseTick, Os_TickType destTick, Os_CounterType CounterID);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern StatusType Os_IncrementHardCounter(CounterType CounterID);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern StatusType Os_GetElapsedValue(CounterType CounterID, TickRefType Value, TickRefType ElapsedValue);
/*============================ @-Counter-@==========================*/
 ...
 */
/******************************************************************************/
extern void Os_GetAlarmBase(AlarmType AlarmID, AlarmBaseRefType Info);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern StatusType Os_WaitAllEvents(EventMaskType Mask);
#endif
/*============================ @-Event-@==========================*/
 ...
 */
/********************************************************************/
extern void Os_InitTmProt(void);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_TmProtTaskStart(Os_TaskType osTaskId, Os_TmProtOptTaskType osOptType);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_TmProtTaskEnd(Os_TaskType osTaskId, Os_TmProtOptTaskType osOptType);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern StatusType Os_TmProtTaskFrameChk(Os_TaskType osTaskId);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_TmProtResStart(ResourceType osResId, Os_TmProtResOccupyType osOccupyType);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_TmProtResEnd(ResourceType osResId);
#endif
 ...
 */
/********************************************************************/
extern void Os_TmProtIsrStart(Os_IsrType osIsrId, Os_TmProtOptIsrType osOptType);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_TmProtIsrEnd(Os_IsrType osIsrId, Os_TmProtOptIsrType osOptType);
/********************************************************************/
/*
 * Brief                <Time frame of task: frame check process.>
 * Service ID           <None>
 ...
 */
/********************************************************************/
extern StatusType Os_TmProtIsrFrameChk(Os_IsrType osIsrId);
#endif
#endif
/*============================ @-Timing Protection-@==========================*/
 ...
 */
/********************************************************************/
extern boolean Os_IgnoreService(void);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern boolean Os_AddressWritable(uint32 Address);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern boolean Os_WrongContext(uint16 AllowedContext);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_TaskEndNoTerminate(void);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern void Os_Isr2OccupyIntRes(void);
/********************************************************************/
/*
 ...
 */
/********************************************************************/
extern boolean Os_CheckObjAcs(ObjectTypeType ObjectType, Os_AppObjectId ObjectID);
#endif
#endif
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern StatusType Os_RpcCallService(RpcInputRefType rpcData);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern void Os_RpcServiceOperation(Os_CoreIdType osCoreId);
#endif
/******************************************************************************/
/*
 * Brief                <Os panic>
 ...
 */
/******************************************************************************/
extern StatusType Os_IocEmpty(Os_IocComIdType comId);
 ...
 */
/******************************************************************************/
extern StatusType Os_IocTransmit(
 ...
 */
/******************************************************************************/
extern StatusType Os_IocReceive(Os_IocComIdType comId, Os_IocReceiveDataSourceType* pData, Os_IocU16Type paraNum);
 ...
 */
/******************************************************************************/
StatusType Os_IocRemoteCallBack(Os_IocComIdType comId, Os_IocU16Type vReceiverId, Os_ApplicationType vRecAppId);
#endif
/*============================ @-IOC-@=====================================*/
 ...
 */
/******************************************************************************/
extern void Os_StackMonitor(Os_StackPtrType pStack);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern void Os_FillStack(Os_StackType stack);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern void Os_InitSystemStack(void);
#endif
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern void Os_GetTaskState(TaskType TaskID, TaskStateRefType State);
#endif /* CFG_TASK_MAX > 0U */
 ...
 */
/******************************************************************************/
extern void Os_GetCounterValue(CounterType CounterID, TickRefType Value);
#endif /* CFG_COUNTER_MAX > 0U */
