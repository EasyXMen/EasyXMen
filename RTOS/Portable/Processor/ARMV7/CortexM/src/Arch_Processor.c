...
#include "Os_MemMap.h"
volatile uint32 Os_ArchControl;
...
void Os_ArchFirstEnterTask(void)
{
    ...
    uint32 *Os_ArchTopStkPtr = (uint32 *)OS_ARCH_STACK_ALIGN((uint32)(Os_SCB.sysRunningTCB->taskTop));
    /* PRQA S 3430,3432,0306 -- */ /* MISRA Rule 20.7,Rule-11.4 */
    ...
    *(--Os_ArchTopStkPtr) = 4U;  /* R4 */
    ...
    if ((TRUE == Os_AppCfg[Os_SCB.sysRunningAppID].OsTrusted) && (TRUE != Os_AppCfg[Os_SCB.sysRunningAppID].OsTrustedAppWithProtection))
    {
 ...
 */
/******************************************************************************/
Os_ThreadModeType Os_GetThreadMode(void)
{
 ...
 */
/******************************************************************************/
void Os_SetCpuMode(Os_CPUModeType mode) /* PRQA S 3006 */ /* MISRA CWE-498 */
{
 ...
 */
/******************************************************************************/
uint32 Os_GetControlVale(void) /* PRQA S 3008 */ /* MISRA CWE-498 */
{
 ...
 */
/*****************************************************************************/
void Os_ArchAppTerminateTaskProc(Os_TaskType OsTaskID)
{
    /*add comments to pass QAC.*/
    (void)OsTaskID;
