...
#define Os_Hal_MemProtTaskMap(taskId)           Os_ArchMemProtMap(taskId, OS_LEVEL_TASK)
#define Os_Hal_MemProtIsrMap(isrId)             Os_ArchMemProtMap(isrId, OS_LEVEL_ISR2)
#define Os_Hal_MemProtKernelMap()               Os_ArchMpuDisable()
...
extern void Os_ArchDisableMpuRegion(uint8 region);
extern void Os_ArchMpuDisable(void);
extern void Os_ArchMpuConfigTableInit(void);
extern void Os_ArchMpDefaultConfigSwitch(void);
extern void Os_ArchMemProtMap(uint16 Id, Os_CallLevelType Level);
extern uint8 Os_ArchGetFault(void);

extern void Os_Hal_InitKnMemMap(void);
extern void Os_Hal_MemProtEnable(void);
