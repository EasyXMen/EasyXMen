...
#define OS_MPU_REGION_NUM_ALL_SRAM_SPACE   (0u)
#define OS_MPU_REGION_NUM_ALL_APP_DATA     (1u)
#define OS_MPU_REGION_NUM_CUR_APP_PRI_DATA (2u)
#define OS_MPU_REGION_NUM_CUR_TASK_DATA    (3u)
#define OS_MPU_REGION_NUM_CUR_ISR_DATA     (3u)
#define OS_MPU_REGION_NUM_SHARED_SPACE     (4u)
#define OS_MPU_REGION_NUM_ALL_PERI_SPACE   (5u)
#define OS_MPU_REGION_NUM_ALL_PFLASH_SPACE (6u)
/* The configuration of the following two areas can be added according to the hardware environment */
#define OS_MPU_REGION_NUM_ALL_APP_CODE     (7u)
#define OS_MPU_REGION_NUM_CUR_APP_CODE     (8u)
#define OS_MPU_REGION_USEMAX_NUM           (9u)

#define REGION_8                           (8u)
#define REGION_16                          (16u) 
...
#define CODE_ADDR_START  __CODE_START
...
extern void Os_SetMpuRegion(uint8 region, uint32 base, uint32 size, uint32 access);
extern void Os_DisableMpuRegion(uint8 region);
extern void Os_MpuEnable(void);
extern void Os_MpuDisable(void);
extern void Os_ArchInitKnMemMap(void);
extern void Os_ArchMemProtEnable(void);
extern void Os_MpuConfigTableInit(void);
extern void Os_MpuIsrSwitch(ISRType IsrId, ApplicationType HostAppId);
extern void Os_MpuTaskSwitch(TaskType TaskId, ApplicationType HostAppId);
extern void Os_ArchMpDefaultConfigSwitch(void);
extern uint8 Os_GetFault(void);
#if ((OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
extern uint32 Os_CaculateMemSize(const uint8* startAddr, const uint8* endAddr);
#endif
extern Os_MpuRegionType Os_TaskMpuRegion;
extern Os_MpuRegionType Os_Isr2MpuRegion;
#endif
