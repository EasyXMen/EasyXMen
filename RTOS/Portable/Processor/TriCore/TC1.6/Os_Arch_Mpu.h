 ...
 **  @date               : 2024/02/10
 **  @vendor             : isoft
 **  @description        : Arch header file for Mpu api declarations
 **
 ***********************************************************************************************************************/
...
#define PSW_PRS_SET0   (0x00UL)
#define PSW_PRS_SET1   (0x01UL)
#define PSW_PRS_SET2   (0x02UL)
#define PSW_PRS_BIT    (12U)
#define PSW_PRS_MASK   (0xFFFF4FFFu)
...
#define Os_Hal_MemProtEnable()                  \
    {                                           \
        ...
        temp |= (uint32)(1 << MPROT_ENABLE_BIT);                    \
...
/* PRQA S 3458 -- */
#define Os_ArchMemProtSwithToUser() Os_ArchUpdatePsw()
#else /* FALSE == CFG_MEMORY_PROTECTION_ENABLE */
/* Enable the enable bits for memory protection in PSW. */
#define Os_ArchMemProtSwithToSystem()
#define Os_ArchPrintRegisters()
#define Os_ArchMemProtSwithToUser()
#define Os_CLEAR_CDC_ISR2_EPILOGUE()
#endif /* TRUE == CFG_MEMORY_PROTECTION_ENABLE */
/*=======[T Y P E   D E F I N I T I O N S]====================================*/
/*=======[E X T E R N A L   D A T A]==========================================*/
#if (TRUE == CFG_MEMORY_PROTECTION_ENABLE)
extern uint32 Os_PSW_PRS;
/*=======[E X T E R N A L   F U N C T I O N   D E C L A R A T I O N S]========*/

/*update PSW for memory protection and user mode 1*/
static inline OS_ALWAYS_INLINE void Os_ArchUpdatePsw(void) /* PRQA S 3006 */ /* VL_Os_3006 */
{
    uint32 temp = 0u;
    temp        = OS_ARCH_MFCR(OS_REG_PSW);
    temp &= PSW_PRS_MASK;
    ...
    {
        temp = temp & PSWIO_MASK;
        temp = temp | PSWIO_USER1_MODE;
    }
 ...
 */
/******************************************************************************/
extern void Os_ArchSetMemProtSet(uint32 MpSetIdx);
/******************************************************************************/
/*
 ...
 */
/******************************************************************************/
extern uint32 Os_ArchGetMemProtSet(void);
