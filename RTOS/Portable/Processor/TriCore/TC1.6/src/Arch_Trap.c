...
Os_traphnd Tdisptab[OS_MAX_TRAPS]; /* PRQA S 3672 */ /* VL_Os_3672 */
/* PRQA S 1533 -- */
...
/*=======[E X C I P T I O N]==================================================*/
/* PRQA S 3120, 0597, 2740, 2880, 2870 ++ */ /* VL_QAC_MagicNum, VL_Os_0597, VL_Os_2740, VL_Os_2880, VL_Os_2870 */
...
void Os_SystemCallTrap(uint16 Os_Tin) /* PRQA S 3006 */ /* VL_Os_3006 */
/* PRQA S 1532 -- */
{
...
void Trap0(uint16 Os_Tin)
{
    ...
    case 0:
        ...
        Os_CallErrorHook(E_OS_Virtual_Address_Fill);
#endif
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Virtual_Address_Protection);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
        /* OS245:  protection exception hook. */
    ...
    default:
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_PROTECTION_EXCEPTION);
#endif
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_PROTECTION_MEMORY);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
 ...
 */
/******************************************************************************/
/* PRQA S 6010, 6020 ++ */ /* VL_QAC_6010, VL_QAC_6020 */
void Trap2(uint16 Os_Tin)
{
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_PROTECTIONHOOK)
    uint32 whoHook = OS_TMPROT_HOOK_OSAPP;
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Illegal_Opcode);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
        /* OS245:  protection exception hook. */
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Unimplemented_Opcode);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
        /* OS245:  protection exception hook. */
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Invalid_Operand);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
        /* OS245:  protection exception hook. */
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Data_Address_Align);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
        /* OS245:  protection exception hook. */
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Invalid_Local_Memory);
#endif
#if (TRUE == CFG_PROTECTIONHOOK)
        /* OS245:  protection exception hook. */
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Free_Context_List_Depletion);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Call_Depth_Overflow);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Call_Depth_Underflow);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Free_Context_List_Underflow);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Call_Stack_Underflow);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Context_Type);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Nesting_Error);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Program_Fetch_Synchronous);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Data_Access_Synchronous);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Data_Acess_Asynchronous);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Coprocessor_Trap_Asynchronous);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Program_Memory_Integrity);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Data_Memory_Integrity);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Temporal_Asynchronous);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Arithmetic_Overflow);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
...
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_ERRORHOOK)
        Os_CallErrorHook(E_OS_Sticky_Arithmetic_Overflow);
#endif
/* OS245:  protection exception hook. */
#if (TRUE == CFG_PROTECTIONHOOK)
 ...
 */
/******************************************************************************/
void Trap7(uint16 Os_Tin) /* Non-Maskable Interrupt */
/* PRQA S 1532 -- */
{
#if ((OS_SC2 == CFG_SC) || (OS_SC3 == CFG_SC) || (OS_SC4 == CFG_SC))
#if (TRUE == CFG_PROTECTIONHOOK)
...
#include "Os_MemMap.h"
/* PRQA S 3120, 0597, 2740, 2880, 2870 -- */
/*=======[E N D   O F   F I L E]==============================================*/
