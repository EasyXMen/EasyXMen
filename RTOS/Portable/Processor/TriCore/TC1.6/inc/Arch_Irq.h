...
#else /* #if CFG_ISR2_MAX == 0U */ /* PRQA S 2053 */ /* VL_Os_2053 */
#define Os_ArchSwitch2ISR2Stk(isrId)
...
/* Save the context. */
#define OS_ARCH_SAVE_CONTEXT() /* PRQA S 3472 */ /* VL_Os_3472 */             \
    do                                                                        \
    {                                                                         \
...
extern Os_isrhnd Cdisptab[OS_MAX_INTRS]; /* PRQA S 3672 */ /* VL_Os_3672 */
extern uint32    TriCore_int_table[]; /* PRQA S 3684 */    /* VL_Os_3684 */
#if (TRUE == CFG_TIMING_PROTECTION_ENABLE)
extern volatile boolean Os_TprotTerminateIsr;
...
#endif
extern volatile uint32 Os_ArchSp;
 ...
 */
/******************************************************************************/
extern void Os_ArchDisableAllInt_ButTimingProtInt(void);
 ...
 */
/******************************************************************************/
extern void Os_ArchEnableAllInt_ButTimingProtInt(void);
...
extern void Os_ResumeContext(void);
extern void Os_ReturnFromISR1(void);

#if (TRUE == CFG_TIMING_PROTECTION_ENABLE)
extern void Os_ReturnFromISR2(void);
#endif

extern void Os_UpdatePsw(void);
