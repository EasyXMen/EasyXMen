...
/* PRQA S 3458 ++ */                                /* VL_Os_3458 */
#define Os_ArchPreSwitch2System() /* PRQA S 3219 */ /* VL_Os_3219 */                   \
    {                                                                                  \
...
typedef struct
{
    uint32 reg[16]; /* PRQA S 3132 */ /* VL_Os_3132 */
} Os_ArchCsaType;
...
extern volatile uint32   Os_TempPcx;
extern volatile uint32   Os_LoopPcx;
extern volatile uint32   Os_EndPcx;
extern uint32            Os_NextPcx;
 ...
 */
/******************************************************************************/
extern void Os_ArchInitCsas(void);
