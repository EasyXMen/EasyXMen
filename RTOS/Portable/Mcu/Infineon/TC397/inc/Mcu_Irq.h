...
#define OS_INTERRUPT_DISABLEREQ(src) (*((uint32 volatile*)(src))) &= ~((uint32)1U << OS_SRC_SRE_BIT);
/* PRQA S 3412 -- */
...
#define OS_INTERRUPT_ENABLEREQ(src)                                     \
    {                                                                   \
        (*((uint32 volatile*)(src))) |= ((uint32)1u << OS_SRC_SRE_BIT); \
    }
/* PRQA S 3458 -- */
...
/* Request an interrupt service to the specified core. */
/* PRQA S 3458 ++ */                                /* VL_Os_3458 */
#define Os_ArchRemoteCall(coreId) /* PRQA S 3472 */ /* VL_Os_3472 */ \
    {                                                                \
...
{
    uint8     IntPrio;
    Os_isrhnd ISR; /* PRQA S 0784 */ /* VL_Os_0784 */
} Os_IntInstallType;
 ...
 */
/******************************************************************************/
extern void Os_ArchDisableIntInApp(const Os_ApplicationCfgType* posCurAppCfg);
