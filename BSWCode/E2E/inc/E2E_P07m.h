...
counter jump, which changed more than the allowed delta*/
    E2E_P07MSTATUS_WRONGSEQUENCE = 64
...
/**
 * @brief        Protects the array/buffer to be transmitted using the E2E profile 7m.
...
/**
 * @brief        Checks the Data received using the E2E profile 7m. This includes
...
/**
 * @brief       The function maps the check status of profile 7m to a generic check status, which can be
 *              used by E2E state machine check function. The E2E profile 7m delivers a more fine-granular
