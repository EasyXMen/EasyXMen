...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_SomeIpTp_MacroDefineSpecifierKeyword
      Reason: make it easy for code test.
      Risk:  sometimes it not easy to notice what it really means.
      Prevention: no need preventation.

     \li VL_SomeIpTp_ StaticStorageDeclaredAtBlockScope
      Reason: make it easy for code test.
      Risk: static storage duration declared at block scope.
      Prevention: no need preventation.
