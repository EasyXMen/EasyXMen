...
#else
#error "FlsTst_MemMap.h, section is used consecutively many times."
#endif
#define FLSTST_START_SEC_CODE_NO_MATCH
#define START_SEC_CODE

#elif defined FLSTST_STOP_SEC_CODE
#undef FLSTST_STOP_SEC_CODE
#undef MEMMAP_ERROR
#ifdef FLSTST_START_SEC_CODE_NO_MATCH
#undef FLSTST_START_SEC_CODE_NO_MATCH
#else
#error "FlsTst_MemMap.h, no matching section was used."
#endif
...
/*Index:1  Section name :VAR_NO_INIT_8BIT*/
#elif defined FLSTST_START_SEC_VAR_NO_INIT_8BIT
#undef FLSTST_START_SEC_VAR_NO_INIT_8BIT
#undef MEMMAP_ERROR
#ifndef MEMMAP_ERROR_SEC_NO_MATCH
#define MEMMAP_ERROR_SEC_NO_MATCH
#else
#error "FlsTst_MemMap.h, section is used consecutively many times."
#endif
#define FLSTST_START_SEC_VAR_NO_INIT_8BIT_NO_MATCH
#define START_SEC_VAR_NO_INIT_8BIT

#elif defined FLSTST_STOP_SEC_VAR_NO_INIT_8BIT
#undef FLSTST_STOP_SEC_VAR_NO_INIT_8BIT
#undef MEMMAP_ERROR
#ifdef FLSTST_START_SEC_VAR_NO_INIT_8BIT_NO_MATCH
#undef FLSTST_START_SEC_VAR_NO_INIT_8BIT_NO_MATCH
#else
#error "FlsTst_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
/*Index:2  Section name :VAR_NO_INIT_UNSPECIFIED*/
...
#error "FlsTst_MemMap.h, section is used consecutively many times."
#endif
#define FLSTST_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_MATCH
...
#undef MEMMAP_ERROR
#ifdef FLSTST_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_MATCH
#undef FLSTST_START_SEC_VAR_NO_INIT_UNSPECIFIED_NO_MATCH
#else
#error "FlsTst_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
