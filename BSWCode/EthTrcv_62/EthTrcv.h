...
extern CONST(EthTrcv_ConfigType, ETHTRCV_CONST) EthTrcv_62_Config[ETHTRCV_TRCVS_NUM];
 ...
 */
/******************************************************************************/
extern FUNC(void, ETHTRCV_CODE) EthTrcv_62_Init(P2CONST(EthTrcv_ConfigType, ETHTRCV_CONST, ETHTRCV_CONST) CfgPtr);
