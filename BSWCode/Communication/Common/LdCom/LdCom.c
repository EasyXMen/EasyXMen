...
/* PRQA S 1532,3432 ++ */ /* VL_QAC_OneFunRef,VL_LdCom_MacrosFunctionUsed */
/******************************************************************************
...
LdCom_TpTxConfirmation(PduIdType id, Std_ReturnType result)
{
#if (STD_ON == LDCOM_DEV_ERROR_DETECT)
    if (!LdCom_InitStatus)
    {
...
LdCom_TpRxIndication(PduIdType id, Std_ReturnType result)
{
#if (STD_ON == LDCOM_DEV_ERROR_DETECT)
    if (!LdCom_InitStatus)
    {
...
LdCom_TxConfirmation(PduIdType TxPduId)
{
#if (STD_ON == LDCOM_DEV_ERROR_DETECT)
    if (!LdCom_InitStatus)
    {
...
#include "LdCom_MemMap.h"
/* PRQA S 3673 ++ */ /* VL_LdCom_ConstPointer */
