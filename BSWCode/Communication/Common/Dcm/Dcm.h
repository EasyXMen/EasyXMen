...
/**
  ...
  RuleSorce:puhua_rules-2024.12.rcf
    ...
    \li VL_Dcm_3408
      Reason: The constant Dcm_GeneralCfg and Dcm_Cfg is defined in dcm_cfg.c and declared in Dcm_Internal.h. Header not
  included by design for configuration file independence; consistency verified by review.
      Risk: No risk.
      Prevention: None.

    \li VL_Dcm_1039
      Reason: parameter design needs.
      Risk: No risk.
      Prevention: None.

    \li VL_Dcm_4604
      Reason:The parameter name signal in the function pointer typedef coincides with a standard library function name,
  but <signal.h> is not included, so no actual conflict occurs.Usage is local to the type definition and confirmed safe
  by design review.
      Risk: No risk.
      Prevention: None.
  ...
  context
    ...
    \li VL_Dcm_3449
      Reason: Multiple extern declarations of the same function appear in the same translation unit because both
  Dcm.h (BSW) and Rte_Dcm.h (RTE generated) are included. Similarly, some callback functions are declared in both
  Dcm_Cbk.h and SchM_Dcm.h (the latter also generated by RTE). This is an architectural requirement to keep RTE
  independent of BSW internal headers; all declarations have identical signatures. Confirmed safe by review.
      Risk: No risk.
      Prevention: None.

    \li VL_Dcm_3451
      Reason: The function is declared in both Dcm.h (BSW) and Rte_Dcm.h (RTE generated) to expose an encapsulated
  interface to SWCs without pulling in BSW module headers. Similarly, some callback functions are declared in both
  Dcm_Cbk.h and SchM_Dcm.h (the latter also generated by RTE). Multiple declarations across files are by
  design;signatures are identical and verified. Confirmed safe by review.
      Risk: No risk.
      Prevention: None.
 ...
 *            2025-11-04   xue.han             CPT-16254,fix dynamic length data writing for UDS service 0x2e.
 *            2025-11-18   li.feng             CPT-16411,Dcm_SetProgConditions interface prototype error.
 *            2026-01-16   li.feng             CPT-17432,If DcmDslDiagRespMaxNumRespPend = 0, the code permits
 *                                             continuous 0x78 responses (instead of blocking them).
 *  v2.1.20   2026-02-05   xue.han             CPT-17986,fix unexpected multiple transmission in multi-core.
 *            2026-02-06   chao.sun            CPT-17967, When the PDU length for functional addressing is too small,
 *                                             Dcm overruns during copying.
 *  V2.1.21   2026-03-09   xue.han             CPT-16781,Implement async RTE calls in confirmation interface.
 *            2026-03-24   li.feng             CPT-18214,Cannot properly detect if 0x2F is applicable to the new session
 *                                             or security level.
 *            2026-04-01   li.feng             CPT-18290,Logic Optimization for 0x22 Service Reading Duplicate DID as
 *                                                       NvM.
 *  V2.1.22   2026-04-14   tao.yu              CPT-18524, Modify the logic of services 19-04 and 19-06 to optimize
 *                                             execution time.
 *            2026-04-15   li.feng             CPT-18557,When the P2ServerTimeout of service 22 is triggered, an
 *                                             additional message response will be sent.
============================================================================*/
...
#define DCM_SW_PATCH_VERSION         (0x16u) /*Patch version*/
