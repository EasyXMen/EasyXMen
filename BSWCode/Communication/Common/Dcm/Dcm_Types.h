...
typedef struct
{
    P2FUNC(Std_ReturnType, DCM_APPL_CODE, StartProtocolFnc)(Dcm_ProtocolType ProtocolID);
    P2FUNC(Std_ReturnType, DCM_APPL_CODE, StopProtocolFnc)(Dcm_ProtocolType ProtocolID);
...
typedef struct
{
    uint8             Sid;                /**The requested service Id */
...
typedef struct
{
    ...
    Dcm_SecTimerStateType Dcm_SecTimerState[DCM_SECURITY_NUM]; /* PRQA S 1039 */ /* VL_Dcm_1039 */
