 ...
 */
/*************************************************************************/
extern FUNC(void, DCM_CODE) DslInternal_SesRefresh(Dcm_SesCtrlType NewSes, boolean isReached);
#endif /* STD_ON == DCM_SESSION_FUNC_ENABLED */
...
extern void
    Rte_DcmControlCommunicationMode(NetworkHandleType DcmDspComMChannelId, Dcm_CommunicationModeType RequestedMode);
#endif
