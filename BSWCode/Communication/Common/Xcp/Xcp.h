...
/**
  ...
  RuleSorce:puhua-rule.rcf 2.3.1
    ...
    \li VL_Xcp_0305
      Reason: Code design needs.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_Xcp_0310
      Reason: Functional design requirements.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_Xcp_1338
      Reason: Local variable as return value
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
    ...
    \li VL_Xcp_1752
      Reason: The definition of Xcp_Daq_Pdu is generated in the configuration file, and the declaration of
        Xcp_Daq_Pdu is placed in Xcp.h. Xcp_Daq_Pdu is only used within the configuration file; therefore, if
        the definition of Xcp_Daq_Pdu is not generated, Xcp_Daq_Pdu will not be used anywhere. When there is
        only a declaration (but no definition) and the variable is not used, no compilation error will be reported.
      Risk:No risk
      Prevention: None.
...
typedef struct
{
    ...
    P2VAR(Xcp_AGType, TYPEDEF, XCP_CONST) XcpEvChBuffPtr;
