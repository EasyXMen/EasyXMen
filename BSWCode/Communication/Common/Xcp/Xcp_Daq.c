...
#define XCP_START_SEC_VAR_CLEARED_8
#include "Xcp_MemMap.h"
static VAR(uint8, XCP_VAR) Xcp_DaqBuffer[XCP_DTO_BUFFER_SIZE]; /*PRQA S 3218*/ /*VL_Xcp_3218*/
...
/*add timestamp ( if needed )*/
    ...
    if (XCP_EVENT_CONSIST_ODT == Xcp_GlobalCfgPtr->XcpEvCh[daqPtr->eventChannelNum].XcpEvChConsistency)
    {
        ...
        for (entryNum = 0u; entryNum < odtPtr->XcpOdtEntryCount; entryNum++)
        {
            ...
            {
                if (XCP_MAX_DTO >= (((destCnt + 1u) * XCP_AG) + pos)) /*PRQA S 2985*/ /*VL_QAC_2985_2986*/
                {
...
/******************************************************************************/
FUNC(void, XCP_CODE)
Xcp_EventIndication(uint16 eventNum) /* PRQA S 2889 */ /*VL_QAC_MultiReturn*/
{
...
/* check frame length */
#if ((STD_OFF == XCP_CAN_MAX_DLC_REQUIRED) && (STD_ON == XCP_ON_CAN_ENABLE))
    if ((Xcp_CmdLength != 0x08u) && (Xcp_CmdLength != XCP_CAN_MAX_DLC)) /*PRQA S 2995*/ /*VL_Xcp_2995*/
    {
        Xcp_SetErrorCode(XCP_ERR_CMD_SYNTAX);
        Xcp_RespLength = 0x02u;
    }
...
static FUNC(void, XCP_CODE) Xcp_WriteDaqHal(void)
{
    ...
    /* get the address */
    /*PRQA S 2985,2995 ++*/ /*VL_QAC_2985_2986,VL_Xcp_2995*/
    ...
    else
    {
        ...
        len *= XCP_AG; /*PRQA S 2985*/ /*VL_QAC_2985_2986*/
...
{
#if ((STD_OFF == XCP_CAN_MAX_DLC_REQUIRED) && (STD_ON == XCP_ON_CAN_ENABLE))
    if ((Xcp_CmdLength != 8u) && (Xcp_CmdLength != XCP_CAN_MAX_DLC)) /*PRQA S 2995*/ /*VL_Xcp_2995*/
    {
        Xcp_SetErrorCode(XCP_ERR_CMD_SYNTAX);
        Xcp_RespLength = 0x02u;
    }
...
static FUNC(void, XCP_CODE) Xcp_AllocDaqHal(void)
{
    ...
    {
        SchM_Enter_Xcp_Exclusive_Daq();
        for (daqNum = XCP_MIN_DAQ; daqNum < ((uint16)XCP_MIN_DAQ + daqCount); daqNum++)
        {
...
static FUNC(void, XCP_CODE) Xcp_AllocOdtHal(void)
{
    ...
    else
    {
         ...
         * */
        /* PRQA S 3305,0310 ++ */ /* VL_Xcp_3305,VL_Xcp_0310 */
