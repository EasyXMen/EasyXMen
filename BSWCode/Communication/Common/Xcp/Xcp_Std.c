...
static VAR(uint8, XCP_VAR_NO_INIT_8) Xcp_KeyBuffer[XCP_KEY_MAX_LENGTH]; /*PRQA S 3218*/ /*VL_Xcp_3218*/
#define XCP_STOP_SEC_VAR_CLEARED_8
#include "Xcp_MemMap.h"
...
static FUNC(void, XCP_CODE) Xcp_UploadHal(void)
{
    ...
    )
    {
...
#endif
        {
            ...
            Xcp_UpdateMTA((uint32)len * XCP_AG); /*PRQA S 2985*/                      /*VL_QAC_2985_2986*/
            Xcp_RespLength = (len * XCP_AG) + XCP_UPLOAD_DATA_OFFSET; /*PRQA S 2985*/ /*VL_QAC_2985_2986*/
        }
#if (XCP_SLAVE_BLOCK_MODE == STD_ON)
        else
        {
...
Xcp_BuildChecksum(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            Xcp_UpdateMTA(blockSize * XCP_AG); /*PRQA S 2985*/ /*VL_QAC_2985_2986*/
            Xcp_RespLength = 0x08u;
        }
    }
    Xcp_SendResp();
