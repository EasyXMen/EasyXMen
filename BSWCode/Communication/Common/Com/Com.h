 ...
 *  V2.1.31   20260112  jianyu.yang   Add procedure to clear TxIpduStatePtr->RptNum in Com_MainFunction_SendPdu to meet
 * 									                  SWS_Com_00467.
 *  V2.1.32   20260126  jianyu.yang   Modify transmiting condition in Com_TriggerIPDUSend only valid in TP type and fix
 *                                    build bug in Com_ResetTxIpduMDT.
 *  V2.1.33   20260413  jianyu.yang   To fix and block QAC.
 *
 ******************************************************************************/
...
/**
  ...
  and protocols and user configuration
    ...
    \li VL_Com_0310
      Reason: Use to store different data type with same memory size.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

      \li VL_Com_3678
      Reason: Under another configuration the object referceced by pointer is changeable.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
 */
