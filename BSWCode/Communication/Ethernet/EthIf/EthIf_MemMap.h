...
**  Vendor      :                                                             **
**  DESCRIPTION : Memory mapping abstraction declaration of EthIf              **
**                                                                            **
...
#else
#error "EthIf_MemMap.h, section is used consecutively many times."
#endif
#define ETHIF_START_SEC_CODE_NO_MATCH
#define START_SEC_CODE

#elif defined ETHIF_STOP_SEC_CODE
#undef ETHIF_STOP_SEC_CODE
#undef MEMMAP_ERROR
#ifdef ETHIF_START_SEC_CODE_NO_MATCH
#undef ETHIF_START_SEC_CODE_NO_MATCH
#else
#error "EthIf_MemMap.h, no matching section was used."
#endif
...
/*Index:1  Section name :PBCONFIG_DATA_UNSPECIFIED*/
#elif defined ETHIF_START_SEC_PBCONFIG_DATA_UNSPECIFIED
#undef ETHIF_START_SEC_PBCONFIG_DATA_UNSPECIFIED
#undef MEMMAP_ERROR
#ifndef MEMMAP_ERROR_SEC_NO_MATCH
#define MEMMAP_ERROR_SEC_NO_MATCH
#else
#error "EthIf_MemMap.h, section is used consecutively many times."
#endif
#define ETHIF_START_SEC_PBCONFIG_DATA_UNSPECIFIED_NO_MATCH
#define START_SEC_PBCONFIG_DATA_UNSPECIFIED

#elif defined ETHIF_STOP_SEC_PBCONFIG_DATA_UNSPECIFIED
#undef ETHIF_STOP_SEC_PBCONFIG_DATA_UNSPECIFIED
#undef MEMMAP_ERROR
#ifdef ETHIF_START_SEC_PBCONFIG_DATA_UNSPECIFIED_NO_MATCH
#undef ETHIF_START_SEC_PBCONFIG_DATA_UNSPECIFIED_NO_MATCH
#else
#error "EthIf_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "EthIf_MemMap.h, section is used consecutively many times."
#endif
#define ETHIF_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
...
#undef MEMMAP_ERROR
#ifdef ETHIF_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
#undef ETHIF_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
#else
#error "EthIf_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "EthIf_MemMap.h, wrong pragma command"
#endif
