...
EthSM_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC, AUTOMATIC) VersionInfo)
{
#if (STD_ON == ETHSM_DEV_ERROR_DETECT)
...
EthSM_RequestComMode(NetworkHandleType NetworkHandle, ComM_ModeType ComM_Mode)
{
...
/******************************************************************************/
FUNC(void, ETHSM_CODE)
EthSM_CtrlModeIndication(uint8 CtrlIdx, Eth_ModeType CtrlMode)
{
#if (STD_ON == ETHSM_DEV_ERROR_DETECT)
    if (ETHSM_UNINITED == EthSM_Status)
    {
...
/******************************************************************************/
FUNC(void, ETHSM_CODE)
EthSM_TrcvLinkStateChg(uint8 CtrlIdx, EthTrcv_LinkStateType TransceiverLinkState)
{
#if (STD_ON == ETHSM_DEV_ERROR_DETECT)
    if (ETHSM_UNINITED == EthSM_Status)
    {
...
/******************************************************************************/
FUNC(void, ETHSM_CODE)
EthSM_TcpIpModeIndication(uint8 CtrlIdx, TcpIp_StateType TcpIpState)
{
#if (STD_ON == ETHSM_DEV_ERROR_DETECT)
    if (ETHSM_UNINITED == EthSM_Status)
    {
