...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_EthSwt_3218
      Reason: Static variables only used in one function are necessary for functional usage.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
    ...
    \li VL_EthSwt_1752
      Reason: Obeject is defined within source file of 88Q5050.
      Risk: No risk.
...
/* PRQA S 1513 EOF */ /* VL_EthSwt_1513 */
/***********************************************************************************************************************
 *  INCLUDES
 ***********************************************************************************************************************/
