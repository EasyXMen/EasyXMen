...
typedef struct
{
    P2CONST(EthTrcvMiiInterfaceType, TYPEDEF, ETHTRCV_CONFIG_DATA) MiiInterface;
    P2CONST(EthTrcvSwitchInterfaceType, TYPEDEF, ETHTRCV_CONFIG_DATA) SwitchInterface;
...
typedef struct
{
    ...
    P2CONST(EthTrcvMgmtInterfaceType, TYPEDEF, ETHTRCV_CONFIG_DATA) MgmtInterface;
