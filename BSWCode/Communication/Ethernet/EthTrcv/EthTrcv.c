...
VAR(Eth_ModeType, ETHTRCV_VAR_NOINIT) EthIf_ReqTrcvMode[ETHTRCV_TRCVS_NUM]; /* PRQA S 1514 */ /* VL_EthTrcv_1514 */
...
EthTrcv_Init(P2CONST(EthTrcv_ConfigType, ETHTRCV_CONST, ETHTRCV_CONST) CfgPtr)
{
...
#endif
    {
        ...
        for (trcvIdx = 0; trcvIdx < ETHTRCV_TRCVS_NUM; trcvIdx++)
        {
            ...
            CtrlIdx = EthTrcv_TrcvPbCfg[trcvIdx].MgmtInterface->MiiInterface->EthTrcvCtrlIdx;
            MiiIdx  = EthTrcv_TrcvPbCfg[trcvIdx].MgmtInterface->MiiInterface->EthTrcvMiiIdx;
