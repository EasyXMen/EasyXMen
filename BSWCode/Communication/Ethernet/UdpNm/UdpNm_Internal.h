...
#define UDPNM_CBV_BIT_RMR_MASK ((uint8)(0x01u))
...
#define UdpNm_SetTxPduCbvBit(chIndex, mask) /* PRQA S 3472 */ /* VL_UdpNm_MacroFunc */                         \
    do                                                                                                         \
    {                                                                                                          \
...
#define UdpNm_ClrTxPduCbvBit(chIndex, mask) /* PRQA S 3472 */ /* VL_UdpNm_MacroFunc */                          \
    do                                                                                                          \
    {                                                                                                           \
        if (UDPNM_PDU_OFF != UdpNm_CfgPtr->ChannelConfig[chIndex].PduCbvPosition)                               \
        {                                                                                                       \
...
/* detected Remote Sleep */
    ...
    uint8 aggRawPnData[UDPNM_PN_INFO_LENGTH];
#endif
