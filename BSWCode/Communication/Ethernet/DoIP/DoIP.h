...
/**
  ...
  RuleSorce:puhua_rules-2024.12.rcf
    ...
    \li VL_MTR_DoIP_STCYC
      Reason: Due to the implementation requirements of some functions, the functions were not separated into
    sub-functions
    ...
    \li VL_MTR_DoIP_STMIF
      Reason: The API is based on the design requirements
      Risk: The code is difficult to maintain.
      Prevention: Design and code review, and have a clear structure and annotated code.

    \li VL_MTR_DoIP_STPAR
      Reason: The API is based on the design requirements
  ...
  context
    ...
    \li VL_MTR_DoIP_STLIN
      Reason: DiagMsgHandleHeaderReceived function logics are overly complex. Splitting and implementing them will
 ...
 *  V2.0.25      2025-10-29   li.feng         Fix CPT-16187,When the Protocol version in the routing activation message
 *                                            is FF (default value), activation works normally.
 *               2026-01-22   li.feng         Issues identified during the code review for Yanfeng
============================================================================*/
/* PRQA S 1753 EOF */       /* VL_DoIP_1753 */
