...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_MTR_EthTSyn_QacSTPAR
      Reason: Keep prototype align with AUTOSAR SWS.
      Risk:  No risk
      Prevention: None

    \li VL_EthTSyn_2992
      Reason: The value of this if controlling expression might be always true.
      Risk: No risk.
    ...
    \li VL_EthTSyn_1339
      Reason: Confirm that this parameter is merely an intermediate transitional variable and has no risk implications.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.
*/
/******************************************************************************
