...
typedef struct
{
    ...
    const EthTSyn_GlobalTimeMasterCfgType* EthTSynGlobalTimeMaster;
    /* Configuration of a time slave. Each global time domain is
    required to have at least one time slave. */
    const EthTSyn_GlobalTimeSlaveCfgType* EthTSynGlobalTimeSlave;
...
calculation and message authentication process. */
    const EthTSyn_GlobalTimeFollowUpDataIDListCfgType* EthTSynGlobalTimeFollowUpDataIDList;
    /* The number of EthTSynPortConfig */
    uint8 EthTSynPortConfigNum;
    /* Configuration of the EthTSyn-Ports within the TimeDomain. */
    const EthTSyn_PortConfigType* EthTSynPortConfig;
} EthTSyn_GlobalTimeDomainCfgType;

typedef struct
{
    const EthTSyn_GlobalTimeDomainCfgType* EthTSynGlobalTimeDomain;
} EthTSyn_ConfigType;
