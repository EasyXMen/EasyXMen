...
typedef struct
{
    ...
    P2CONST(Sd_CharType, TYPEDEF, SD_CONST) SdCapabilityRecordKey;

    /*@req <ECUC_SD_00074> */
    /* Defines the corresponding CapabilityRecord value. */
    P2CONST(Sd_CharType, TYPEDEF, SD_CONST) SdCapabilityRecordValue;
...
typedef struct
{
    ...
    P2CONST(Sd_CharType, TYPEDEF, SD_CONST) SdInstanceHostname;
