...
**                                                                            **
*******************************************************************************/
/* PRQA S 6620 EOF */ /* VL_MTR_Sd_STSCT */
/***************************Change History*************************************/
/* V0.1.0   2019/3/11   hurongbo
   ...
   V2.0.11  2022/08/26 hurongbo
            ...
            `> Fix bug:macro SD_BSWM_USED deactive too much code in some case
               (JIRA:PRE0012022-106)
   ...
   V2.0.27  2025/9/30 zouzhijia
            fix bug CPT-15379,CPT-15841
*/

/* PRQA S 6540 EOF */ /* VL_MTR_Sd_STTPP */
/* PRQA S 6510 EOF */ /* VL_MTR_Sd_CONF */
/* PRQA S 6520 EOF */ /* VL_MTR_Sd_STVAR */
/* PRQA S 6620 EOF */ /* VL_MTR_Sd_STSCT */
/* PRQA S 6040 EOF */ /* VL_MTR_Sd_STPAR */
/* PRQA S 6010 EOF */ /* VL_MTR_Sd_STCYC */
/* PRQA S 6020 EOF */ /* VL_MTR_Sd_STLIN */
/* PRQA S 6080 EOF */ /* VL_MTR_Sd_STPTH */
/* PRQA S 6030 EOF */ /* VL_MTR_Sd_STMIF */
/* PRQA S 6050 EOF */ /* VL_MTR_Sd_STST3 */
/* PRQA S 6070 EOF */ /* VL_MTR_Sd_STCAL */
/* PRQA S 6060 EOF */ /* VL_MTR_Sd_STM19 */
/* PRQA S 2889 EOF */ /* VL_QAC_MultiReturn */
/* PRQA S 0316 EOF */ /* VL_QAC_0316 */
/* PRQA S 0489 EOF */ /* VL_Sd_0489 */
...
#define SD_NETWORK_MASK_VALUE_RESERVED               255u
...
#define SD_MESSAGE_TYPE1_OPTION_FIRST_THREE_BYTE_LEN 3u
...
typedef struct
{
    ...
    uint16 InstanceID;
    uint8  MajorVersion;
    uint8  TTL[SD_TYPE1_ENTRY_TTL_FIELD_LENGTH];
    uint32 MinorVersion;
} Sd_Type1EntryType;
...
typedef struct
{
    ...
    uint8  Type;
    uint8 : 8; /* Reserved */
    uint8 IPv4Address[SD_IPV4_ADDRESS_LEN];
    uint8 : 8; /* Reserved */
    uint8  L4Proto;
    uint16 PortNumber;
} Sd_IPv4OptionsType;
...
typedef struct
{
    ...
    uint8  Type;
    uint8 : 8; /* Reserved */
    uint8 IPv6Address[SD_IPV6_ADDRESS_LEN];
    uint8 : 8; /* Reserved */
    uint8  L4Proto;
    uint16 PortNumber;
} Sd_IPv6OptionsType;
...
typedef struct Sd_SendQueueType_
{
    ...
    uint16                    optStartPos[SD_OPT_START_POSTITION_LEN]; /* Max 3 options */
    uint16                    optionLen;
    uint8                     optionNum;
...
typedef struct Sd_TriggerTransmitManagerType_
{
    struct Sd_TriggerTransmitManagerType_* next;
...
typedef struct
{
    ...
    Sd_TriggerTransmitManagerType*  udpTriggerTransmitList;
    Sd_TriggerTransmitManagerType*  tcpTriggerTransmitList;
...
{
    uint16 serviceHandleId[SD_ARRAY_LEN_16]; /* Memory fragmentation avoid, allocate 16 member each time */
...
static Std_ReturnType
    Sd_OptionsExistCheck(const Sd_InstanceType* instancePtr, const uint8* sdMsg, uint32 entryArrayLen, uint8 optNum);
...
#if (SD_CLIENT_SERVICE_NUM > 0)
static Std_ReturnType
    Sd_BuildFindServiceEntry(const Sd_InstanceType* sdInstancePtr, const Sd_ClientServiceType* clientServicePtr);
#endif
...
#if (SD_SERVER_SERVICE_NUM > 0)
static Sd_Type1EntryType*
    Sd_CreateOfferServiceEntry(const Sd_ServerServiceType* serverServicePtr, boolean isStopOfferService);
...
#if (SD_SERVER_SERVICE_NUM > 0)
static void
    Sd_ServerServiceDownPhaseHandle(const Sd_InstanceType* instancePtr, const Sd_ServerServiceType* serverServicePtr);
...
static void
    Sd_ServerServiceMainPhaseHandle(const Sd_InstanceType* instancePtr, const Sd_ServerServiceType* serverServicePtr);

static void
    Sd_ServerServiceDownPhaseEnter(const Sd_InstanceType* instancePtr, const Sd_ServerServiceType* serverServicePtr);

static void
    Sd_ServerServiceInitialWaitEnter(const Sd_InstanceType* instancePtr, const Sd_ServerServiceType* serverServicePtr);

static void
    Sd_ServerServiceTimerHandle(const Sd_InstanceType* instancePtr, const Sd_ServerServiceType* serverServicePtr);
#endif

#if (SD_CLIENT_SERVICE_NUM > 0)
static void
    Sd_ClientServiceDownPhaseHandle(const Sd_InstanceType* instancePtr, const Sd_ClientServiceType* clientServicePtr);
...
static void
    Sd_ClientServiceMainPhaseHandle(const Sd_InstanceType* instancePtr, const Sd_ClientServiceType* clientServicePtr);
...
static void Sd_AddClientToTriggerTransmitList(
    ...
    SoAd_SoConIdType                soConId);
static void
    Sd_DelClientFromTriggerTransmitListBySoConId(Sd_TriggerTransmitManagerType** head, SoAd_SoConIdType soConId);
static Sd_TriggerTransmitManagerType* Sd_PopFirstClientFromTriggerTransmitList(Sd_TriggerTransmitManagerType** head);

static Sd_SubscribeManageType*
    Sd_GetSubscribeManageObjAddr(Sd_SubscribeManageType* header, TcpIp_SockAddrType sockRemoteAddr, uint8 counter);
...
static Sd_SessionIdCtrlType*
    Sd_AddRemoteAddrToSessionIdCtrlList(uint16 instanceId, const Sd_RxQueueType* rxQueueItem, boolean isRxUseMulticast);
...
#if (SD_EVENT_HANDLER_NUM > 0)
static void Sd_RebootStopSubscribeEventHandle(uint16 serverServiceHandleId, const Sd_RxQueueType* rxQueueItem);
#endif /* SD_EVENT_HANDLER_NUM > 0 */
...
static inline void Sd_ReportDetError(uint8 serviceId, uint8 errorId)
{
    (void)Det_ReportError(SD_MODULE_ID, SD_INSTANCE_ID, serviceId, errorId);
}
#endif

/* PRQA S 3219 ++ */ /* VL_Sd_3219 */
static inline void Sd_ReportRuntimeError(uint8 serviceId, uint8 errorId)
{
    (void)Det_ReportRuntimeError(SD_MODULE_ID, SD_INSTANCE_ID, serviceId, errorId);
}
/* PRQA S 3219 -- */

static inline uint16 Sd_Strlen(const Sd_CharType* str)
{
    uint16             length = 0u;
...
void Sd_Init(const Sd_ConfigType* ConfigPtr)
{
    ...
    {
        Sd_ReportDetError(SD_INIT_ID, SD_E_PARAM_POINTER);
        detNoErr = FALSE;
    }
    if (TRUE == detNoErr)
#endif /* STD_ON == SD_DEV_ERROR_DETECT */
    {
...
#if (SD_SERVER_SERVICE_NUM > 0)
        for (index = 0u; index < SD_SERVER_SERVICE_NUM; index++)
        {
            /*@req <SWS_SD_00020> */
        ...
        for (index = 0u; index < SD_EVENT_HANDLER_NUM; index++)
        {
            ...
            Sd_EventHandlerRTData[index].tcpTriggerTransmitList = NULL_PTR;
            Sd_EventHandlerRTData[index].udpTriggerTransmitList = NULL_PTR;
        }
#endif /* SD_EVENT_HANDLER_NUM > 0 */
#endif /* SD_SERVER_SERVICE_NUM > 0 */
...
void Sd_GetVersionInfo(Std_VersionInfoType* versioninfo)
{
    ...
    {
        /*@req <SWS_SD_00497> */
        Sd_ReportDetError(SD_GET_VERSION_INFO_ID, SD_E_PARAM_POINTER);
        detNoErr = FALSE;
    }
    if (TRUE == detNoErr)
#endif
...
Std_ReturnType Sd_ServerServiceSetState(uint16 SdServerServiceHandleId, Sd_ServerServiceSetStateType ServerServiceState)
{
    ...
    {
        Sd_ReportDetError(SD_SERVER_SERVICE_SET_STATE_ID, SD_E_NOT_INITIALIZED);
        detNoErr = FALSE;
    }
    if (SD_INIT_FAIL == Sd_InitResult)
    {
        Sd_ReportDetError(SD_SERVER_SERVICE_SET_STATE_ID, SD_E_INIT_FAILED);
        detNoErr = FALSE;
    }
    if (SdServerServiceHandleId >= SD_SERVER_SERVICE_NUM)
    {
        Sd_ReportDetError(SD_SERVER_SERVICE_SET_STATE_ID, SD_E_INV_ID);
        detNoErr = FALSE;
    }
    if ((SD_SERVER_SERVICE_DOWN != ServerServiceState) && (SD_SERVER_SERVICE_AVAILABLE != ServerServiceState))
    {
        Sd_ReportDetError(SD_SERVER_SERVICE_SET_STATE_ID, SD_E_INV_MODE);
        detNoErr = FALSE;
    }
    if (TRUE == detNoErr)
#endif
...

{
    ...
    if (SD_UNINIT == Sd_Status)
    {
        Sd_ReportDetError(SD_CLIENT_SERVICE_SET_STATE_ID, SD_E_NOT_INITIALIZED);
    }
    else if (SD_INIT_FAIL == Sd_InitResult)
    {
        Sd_ReportDetError(SD_CLIENT_SERVICE_SET_STATE_ID, SD_E_INIT_FAILED);
    }
    else if ((SD_CLIENT_SERVICE_RELEASED != ClientServiceState) && (SD_CLIENT_SERVICE_REQUESTED != ClientServiceState))
    {
        Sd_ReportDetError(SD_CLIENT_SERVICE_SET_STATE_ID, SD_E_INV_MODE);
    }
#if (SD_CLIENT_SERVICE_NUM > 0u)
    else if (ClientServiceHandleId >= SD_CLIENT_SERVICE_NUM)
    {
        Sd_ReportDetError(SD_CLIENT_SERVICE_SET_STATE_ID, SD_E_INV_ID);
    }
#endif
    else
#endif
...

{
    ...
    if (SD_UNINIT == Sd_Status)
    {
        Sd_ReportDetError(SD_CONSUMED_EVENT_GROUP_SET_STATE_ID, SD_E_NOT_INITIALIZED);
    }
    else if (SD_INIT_FAIL == Sd_InitResult)
    {
        Sd_ReportDetError(SD_CONSUMED_EVENT_GROUP_SET_STATE_ID, SD_E_INIT_FAILED);
    }
    else if (
        (SD_CONSUMED_EVENTGROUP_RELEASED != ConsumedEventGroupState)
        && (SD_CONSUMED_EVENTGROUP_REQUESTED != ConsumedEventGroupState))
    {
        Sd_ReportDetError(SD_CONSUMED_EVENT_GROUP_SET_STATE_ID, SD_E_INV_MODE);
    }
#if (SD_CONSUMED_EVENTGROUP_NUM > 0u)
    else if (SdConsumedEventGroupHandleId >= SD_CONSUMED_EVENTGROUP_NUM)
    {
        Sd_ReportDetError(SD_CONSUMED_EVENT_GROUP_SET_STATE_ID, SD_E_INV_ID);
    }
#endif
    else
#endif
    {
        ...
        const Sd_ClientServiceRTType* cRtDataPtr = NULL_PTR;
        uint16                        i, j;

        for (i = 0u; i < SD_CLIENT_SERVICE_NUM; i++)
        {
            const Sd_ClientServiceType* cServicePtr = &Sd_CfgPtr->SdGlbClientService[i];
            for (j = 0u; j < cServicePtr->SdConsumedEventGroupNum; j++)
            {
                const Sd_ConsumedEventGroupType* consumedEgPtr = &cServicePtr->SdConsumedEventGroup[j];
...

{
    ...
    if (SD_UNINIT == Sd_Status)
    {
        Sd_ReportDetError(SD_LOCAL_IP_ADDR_ASSIGMENT_CHG_ID, SD_E_NOT_INITIALIZED);
        detNoErr = FALSE;
    }
    if (SD_INIT_FAIL == Sd_InitResult)
    {
        Sd_ReportDetError(SD_LOCAL_IP_ADDR_ASSIGMENT_CHG_ID, SD_E_INIT_FAILED);
        detNoErr = FALSE;
    }
    if (SoConId >= SOAD_SO_CON_MAX)
    {
        Sd_ReportDetError(SD_LOCAL_IP_ADDR_ASSIGMENT_CHG_ID, SD_E_INV_ID);
        detNoErr = FALSE;
    }
    if ((TCPIP_IPADDR_STATE_ASSIGNED != State) && (TCPIP_IPADDR_STATE_ONHOLD != State)
        && (TCPIP_IPADDR_STATE_UNASSIGNED != State))
    {
        Sd_ReportDetError(SD_LOCAL_IP_ADDR_ASSIGMENT_CHG_ID, SD_E_INV_MODE);
        detNoErr = FALSE;
    }
    if (TRUE == detNoErr)
#endif
...
void Sd_SoConModeChg(SoAd_SoConIdType SoConId, SoAd_SoConModeType Mode)
{
    ...
    if (SD_UNINIT == Sd_Status)
    {
        Sd_ReportDetError(SD_SOCON_MODE_CHG_ID, SD_E_NOT_INITIALIZED);
        detNoErr = FALSE;
    }
    if (SD_INIT_FAIL == Sd_InitResult)
    {
        Sd_ReportDetError(SD_SOCON_MODE_CHG_ID, SD_E_INIT_FAILED);
        detNoErr = FALSE;
    }
    if (SoConId >= SOAD_SO_CON_MAX)
    {
        Sd_ReportDetError(SD_SOCON_MODE_CHG_ID, SD_E_INV_ID);
        detNoErr = FALSE;
    }
    if ((SOAD_SOCON_ONLINE != Mode) && (SOAD_SOCON_RECONNECT != Mode) && (SOAD_SOCON_OFFLINE != Mode))
    {
        Sd_ReportDetError(SD_SOCON_MODE_CHG_ID, SD_E_INV_MODE);
        detNoErr = FALSE;
    }
    if (TRUE == detNoErr)
#endif
    {
        ...
        {
            for (; instanceIdx < SD_INSTANCE_NUM; instanceIdx++)
            {
#if (SD_SERVER_SERVICE_NUM > 0)
...
#endif                                           /* SD_CLIENT_SERVICE_NUM > 0 */
                instancePtr++; /* PRQA S 2983 */ /* VL_Sd_RedundantOpt */
            }
        }
#endif /* SD_INSTANCE_NUM > 0 */
    }
...
void Sd_RxIndication(PduIdType RxPduId, const PduInfoType* PduInfoPtr)
{
    ...
    if (SD_UNINIT == Sd_Status)
    {
        Sd_ReportDetError(SD_RX_INDICATION_ID, SD_E_NOT_INITIALIZED);
        detNoErr = FALSE;
    }
    if (SD_INIT_FAIL == Sd_InitResult)
    {
        Sd_ReportDetError(SD_RX_INDICATION_ID, SD_E_INIT_FAILED);
        detNoErr = FALSE;
    }
    if (NULL_PTR == PduInfoPtr)
    {
        Sd_ReportDetError(SD_RX_INDICATION_ID, SD_E_PARAM_POINTER);
        detNoErr = FALSE;
    }
    if (RxPduId >= SD_RXPDUID_SOCONID_MAP_LEN)
    {
        Sd_ReportDetError(SD_RX_INDICATION_ID, SD_E_INV_ID);
        detNoErr = FALSE;
    }
    if (TRUE == detNoErr)
#endif /* STD_ON == SD_DEV_ERROR_DETECT */
    {
        ...
        else
        {
            ...
            optionArrayLen =
                Sd_NPtrtoHl(&sdMsgPtr[SD_ENTRIES_ARRAY_LENGTH_INDEX + entryArrayLen + SD_MESSAGE_ENTRYLEN_FILED_LEN]);
            /*@req <SWS_SD_00708> */
            minSduLen = (PduLengthType)(SD_HEADER_LEN + SD_MESSAGE_ENTRYLEN_FILED_LEN + entryArrayLen + optionArrayLen
                                        + SD_MESSAGE_OPTIONLEN_FILED_LEN);
                ...
                if ((NULL_PTR != rxQueuePtr) && (NULL_PTR != rxBufPtr))
                {
                    ...
                    for (index = 0u; index < SD_RXPDUID_SOCONID_MAP_LEN; index++)
                    {
                        if (rxPduIdSoConIdMap->SdRxPduId == RxPduId)
                        {
                            ...
                            for (index2 = 0u; index2 < SD_INSTANCE_NUM; index2++)
                            {
...
void Sd_MainFunction(void)
{
    ...
    if (SD_INIT_SUCCESS == Sd_InitResult)
    {
        ...
        for (instanceIdx = 0u; instanceIdx < SD_INSTANCE_NUM; instanceIdx++)
        {
...
static void Sd_ParseRxMessage(void)
{
    ...
    /* PRQA S 2481 -- */
    {
        ...
        optionArrayLen =
            Sd_NPtrtoHl(&sdMsg[SD_ENTRIES_ARRAY_LENGTH_INDEX + entryArrayLen + SD_MESSAGE_ENTRYLEN_FILED_LEN]);
        ...
        for (instanceIdx = 0u; instanceIdx < SD_INSTANCE_NUM; instanceIdx++)
        {
            ...
            instancePtr++; /* PRQA S 2982,2983 */ /* VL_Sd_PointerCalu,VL_Sd_RedundantOpt */
        }
    ...
    const uint16*          optStartPosMap)
{
    ...
    if (localAddrCheckLen > 0u)
    {
        ...
        for (index = 0u; index < optNumSum; index++)
        {
            if (index < numOpt1)
            {
            ...
            optType = sdMsg[optStartPosMap[optIndex] + SD_OPTION_TYPE_FILED_OFFSET];
...
static Std_ReturnType Sd_IsIpAddrInSameSubset(const uint8* ipAddr1, const uint8* ipAddr2, uint8 netmask, uint8 addrLen)
{
    ...
    if (0u != cmpResult)
    {
        (void)ILib_memset(netmaskArray, SD_NETWORK_MASK_VALUE_RESERVED, SD_IP_ADDRESS_MAX_LEN);
        tAddrLen = (uint8)((addrLen) << (SD_BYTE_TO_BIT_CONVERSION_FRACTION)) - netmask;
        clrByte  = tAddrLen >> SD_BYTE_TO_BIT_CONVERSION_FRACTION;
        clrBit   = tAddrLen & SD_MAGIC_INT_0X07;
...
static Std_ReturnType Sd_OptionsConflictCheck(const uint8* sdMsg, uint16 entryPos, const uint16* optStartPosMap)
{
    Sd_Type1EntryType  type1Entry;
    Sd_IPv4OptionsType ipv4Opt;
    uint16             ipv4EndpTcpNum = 0u, ipv4EndpUdpNum = 0u;
#if (STD_ON == SD_IPV6_ENABLE)
    Sd_IPv6OptionsType ipv6Opt;
...
/* @req SWS_SD_00717,SWS_SD_00718 */
        ...
        /*@req <SWS_SD_00486> */
        if (((serviceID == SD_MESSAGE_SERVICE_ID_ANY) || (serviceID == serverServicePtr->SdServerServiceId))
            && ((InstanceID == SD_MESSAGE_INSTANCE_ID_ANY)
                || (InstanceID == serverServicePtr->SdServerServiceInstanceId))
            && ((majorVersion == SD_MESSAGE_MAJOR_VERSION_ANY)
                || (majorVersion == serverServicePtr->SdServerServiceMajorVersion))
            && ((minorVersion == SD_MESSAGE_MINOR_VERSION_ANY)
...
static uint32 Sd_GetRandomValue(uint32 min, uint32 max)
{
    ...
    return (min + (randVal % (max - min + 1u))); /* PRQA S 2834 */ /* VL_Sd_Division */
}
    ...
    boolean                isReplyNAck)
{
    ...
    (void)ILib_memcpy((((uint8*)&ttl) + 1u), type2Entry.TTL, SD_MESSAGE_ENTRY_TTL_FIELD_LEN);
    ttl          = Sd_NtoHl(ttl);
    ...
    boolean                     isStopOfferService)
{
    ...
    {
        /* Clear new allocated memory */
        (void)ILib_memset(sendQueueObjPtr, 0u, sizeof(Sd_SendQueueType));
    }
    ...
    uint8                       counter)
{
    ...
    if (NULL_PTR != eventHandlerPtr)
    {
        ...
        else
        {
            /* Clear new allocated memory */
            (void)ILib_memset(sendQueueObjPtr, 0u, sizeof(Sd_SendQueueType));
            (void)ILib_memset(egAckPtr, 0u, sizeof(Sd_Type1EntryType));
            if (optionsLen > 0u)
            {
                (void)ILib_memset(optionPtr, 0u, optionsLen);
            }
            ...
            tTtl                      = Sd_HtoNl(ttl);
            (void)ILib_memcpy(egAckPtr->TTL, ((uint8*)&tTtl) + 1, SD_MESSAGE_ENTRY_TTL_FIELD_LEN);
    ...
    uint16                      entryPos)
{
    ...
    else
    {
        ...
        ttl                       = 0u;
        (void)ILib_memcpy(egAckPtr->TTL, ((uint8*)&ttl) + 1, SD_MESSAGE_ENTRY_TTL_FIELD_LEN);
    ...
    Sd_CreateOfferServiceEntry(const Sd_ServerServiceType* serverServicePtr, boolean isStopOfferService)
{
    ...
    {
        /* Clear new allocated memory */
        (void)ILib_memset(ofSevsPtr, 0u, sizeof(Sd_Type1EntryType));
        ...
        (void)ILib_memcpy(ofSevsPtr->TTL, ((uint8*)&ttl) + 1, SD_MESSAGE_ENTRY_TTL_FIELD_LEN);
    ...
    Sd_SendQueueType*           sendQueueObjPtr)
{
    ...
    if (NULL_PTR != serverServicePtr->SdServerServiceTcpRef)
    {
        ...
        else
        {
            ...
            tcpEndpointOptLen = (uint16)SD_MESSAGE_IPV6_OPTION_LEN;
        }
#endif /* STD_ON == SD_IPV6_ENABLE */
    }
    ...
    if (NULL_PTR != serverServicePtr->SdServerServiceUdpRef)
    {
        ...
        {
            udpEndpointOptLen = (uint16)SD_MESSAGE_IPV6_OPTION_LEN;
        }
#endif /* STD_ON == SD_IPV6_ENABLE */
    }
    /* Total buffer needed */
    ...
    bufPtr = (uint8*)Sd_MallocEx(bufLenSum, Sd_TxMemPool);
    if (NULL_PTR != bufPtr)
    {
        /* Set all memory to 0x00 */
        (void)ILib_memset(bufPtr, 0u, bufLenSum);
        bufRunIdx = 0u;
        ...
        if (NULL_PTR != serverServicePtr->SdServerServiceTcpRef)
        {
            ...
            optionNum++;
            bufRunIdx += tcpEndpointOptLen; /* PRQA S 2986 */ /* VL_QAC_2985_2986 */
        }
    ...
    const Sd_ClientServiceType* clientServicePtr)
{
    ...
    {
        /* SD_MESSAGE_TYPE1_OPTION_FIRST_FIVE_BYTE_LEN = Length(2) + Type(1) + Reserved(1) + [0](1)*/
    ...
    const Sd_ClientServiceType* clientServicePtr)
{
    ...
    const Sd_CapabilityRecordType* recordPtr;
    const Sd_CharType*             hostnameStr = "hostname";
    ...
    uint16                      cfgOptLen)
{
    ...
    optLen =
        Sd_HtoNs(cfgOptLen - SD_MESSAGE_TYPE1_OPTION_FIRST_THREE_BYTE_LEN); /* Exclude Length(2Byte) and Type(1Byte) */
    (void)ILib_memcpy(optAddr, (uint8*)&optLen, sizeof(uint16));
    ...
    Sd_SetHeader(uint8* headerPtr, uint16 instanceId, const TcpIp_SockAddrType* remoteAddr, boolean isMulticastTx)
{
    ...
    (void)ILib_memset(&header, 0u, sizeof(Sd_HeaderType));

    header.ClientID = 0x00u;
    /* Set SessionId*/
...
static void Sd_SetIPv4EndpointOption(uint8* ipv4OptionPtr, const uint8* ipv4Address, uint8 L4Proto, uint16 portNumber)
{
    ...
    (void)ILib_memset(&ipv4Option, 0u, sizeof(Sd_IPv4OptionsType));
    ipv4Option.Length = Sd_HtoNs(SD_IPV4_ENDPOINT_OPTION_LENGTH);
    ipv4Option.Type   = SD_IPV4_ENDPOINT_OPTION;
    (void)ILib_memcpy(ipv4Option.IPv4Address, ipv4Address, SD_IPV4_ADDRESS_LEN);
    ...
    Sd_ServerServiceDownPhaseEnter(const Sd_InstanceType* instancePtr, const Sd_ServerServiceType* serverServicePtr)
{
    ...
    if (SD_SERVER_SERVICE_DOWN == sRtDataPtr->setState)
    {
            ...
            && (SD_SERVER_PHASE_INITIAL_WAIT != sRtDataPtr->phase)) /* after first OfferService send,in Repetion Phase*/
        {
            ...
            Sd_BuildOfferServiceEntry(instancePtr, serverServicePtr, NULL_PTR, 0u, FALSE, TRUE);
        }
    ...
    else
    {
        if (cRtDataPtr->repetitionTimer > 0u)
        {
            ...
            if (0u == cRtDataPtr->repetitionTimer)
            {
                ...
                {
                    /*@req <SWS_SD_00363> */
                    delayTime = (uint32)0x01u << cRtDataPtr->repetitionCount;
...
static uint32 Sd_NPtrtoHl(const uint8* net32DataPtr)
{
    ...
    (void)ILib_memcpy((uint8*)&net32, net32DataPtr, SD_ENDIAN_SWAP_FOUR_BYTE_LEN);
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
    /* Little Endian need swap */
...
static uint16 Sd_NPtrtoHs(const uint8* net16DataPtr)
{
    ...
    (void)ILib_memcpy((uint8*)&net16, net16DataPtr, SD_ENDIAN_SWAP_TWO_BYTE_LEN);
#if (CPU_BYTE_ORDER == LOW_BYTE_FIRST)
    /* Little Endian need swap */
...
static Std_ReturnType Sd_AddClientToSubscribeList(
    ...
    uint8                    counter)
{
    Sd_SubscribeManageType *ptr = *headerPtr, *subscribePtr = NULL_PTR;
    Std_ReturnType          ret = E_NOT_OK;

    subscribePtr = (Sd_SubscribeManageType*)Sd_MallocEx(sizeof(Sd_SubscribeManageType), Sd_TxMemPool);
    ...
    const uint16*               optStartPosMap)
{
    ...
    for (index = 0u; (index < optNumSum) && (E_OK == ret); index++)
    {
        if (index < numOpt1)
        {
            optIndex = idx1stOptions + index;
    ...
    uint8                       counter)
{
    ...
    if (ttl > 0u)
    {
        ...
        for (loop = 0u; loop < soConNum; loop++)
        {
            ...
            if (NULL_PTR != ipv4OptPtr)
            {
                ...
                isSameIpAddr = ILib_memcmp((uint8*)sockAddr.addr, ipv4OptPtr->IPv4Address, SD_IPV4_ADDRESS_LEN);
            }
            else if (NULL_PTR != ipv6OptPtr)
            {
                sockAddr.domain = TCPIP_AF_INET6;
                (void)SoAd_GetRemoteAddr(soConId, &sockAddr);
                isSameIpAddr = ILib_memcmp((uint8*)sockAddr.addr, ipv6OptPtr->IPv6Address, SD_IPV6_ADDRESS_LEN);
            }
            else
            {
                /* Nothing to do here */
    ...
    else
    {
        ...
        if (NULL_PTR != ipv4OptPtr)
        {
            ...
            (void)ILib_memcpy((uint8*)sockAddr.addr, (const uint8*)ipv4OptPtr->IPv4Address, SD_IPV4_ADDRESS_LEN);
        }
        else
        {
            sockAddr.domain = TCPIP_AF_INET6;
            sockAddr.port   = Sd_NtoHs(ipv6OptPtr->PortNumber);
            (void)ILib_memcpy((uint8*)sockAddr.addr, (const uint8*)ipv6OptPtr->IPv6Address, SD_IPV6_ADDRESS_LEN);
        }
    ...
    uint8                       counter)
{
    ...
    if (E_OK == ret)
    {
        ...
        if (NULL_PTR == subscribeManagePtr)
        {
            if (ttl > 0u)
            {
                if (ehRTDataPtr->udpSubsClientNum < SD_MAX_SUBSCRIBE_CLIENT_NUM) /* max 16 client */
                {
                    /* Add client to subscribe list */
 ...
 * Param-Name[in]: routingGroupId,soConId
    ...
    SoAd_SoConIdType                soConId)
{
    Sd_TriggerTransmitManagerType* tmpNode =
        (Sd_TriggerTransmitManagerType*)Sd_MallocEx(sizeof(Sd_TriggerTransmitManagerType), Sd_TxMemPool);
    if (tmpNode == NULL_PTR)
    {
        return;
    }
 ...
 */
/******************************************************************************/
static void Sd_DelClientFromTriggerTransmitListBySoConId(Sd_TriggerTransmitManagerType** head, SoAd_SoConIdType soConId)
{
    ...
    {
        *head = tmpNode->next;
        Sd_FreeEx(tmpNode, Sd_TxMemPool);
    }
    else
    {
    ...
    SoAd_SoConIdType           assignedSoConId)
{
    ...
    if ((NULL_PTR != eventHandlerUdpPtr) && (NULL_PTR != eventHandlerUdpPtr->SdEventTriggeringRef))
    {
        routingGroupId = eventHandlerUdpPtr->SdEventTriggeringRef->SdRoutingGroupId;
        /* PATCH for TC8: Field event transmit befor ACK */
        Sd_AddClientToTriggerTransmitList(&ehRTDataPtr->udpTriggerTransmitList, routingGroupId, assignedSoConId);
    }
}
    ...
    uint8*        udpEndpointNum)
{
    ...
    uint8 optType;
    uint8 optIndex;
    uint8 ipv4EndpTcpNum = 0u, ipv4EndpUdpNum = 0u;
    uint8 ipv6EndpTcpNum = 0u, ipv6EndpUdpNum = 0u;
    uint8 optNumSum;
    ...
    boolean                 isMulticastTx)
{
    ...
    Std_ReturnType     ret         = E_NOT_OK;
    uint32             headerLen   = 0u;
    uint32             entryOffset = 0u;

    /* Calculate message length */
    entryTotalLen = (uint16)sendQueCnt * SD_MESSAGE_ENTRY_TOTAL_LEN;
    ...
    if (NULL_PTR != messagePtr)
    {
        ...
        (void)ILib_memcpy(&messagePtr[SD_HEADER_LEN], (uint8*)&tLengthField, sizeof(uint32));
    ...
    uint8                   uniSendCnt)
{
    ...
    (void)ILib_memset(numPerAddrKind, 0u, SD_MAX_ENTRIES_PER_FRAME);
    ...
    for (i = 0u; i < numAllKind; i++)
    {
        ...
        destAddr = sendQue[0]->destAddr; /* PRQA S 2813 */ /* VL_Sd_PointerIsNull */
    ...
    uint16                    serverServiceHandleId)
{
    ...
    if (!TCPIP_IS_IPADDR_ANY(*remoteAddrPtr))
    {
        ...
        if (NULL_PTR != sesIdCtrlPtr)
        {
            ...
            {
                serverServiceList =
                    (Sd_ServiceHandleIdListType*)Sd_MallocEx(sizeof(Sd_ServiceHandleIdListType), Sd_RxMemPool);
                if (NULL_PTR != serverServiceList)
                {
    ...
    Sd_AddRemoteAddrToSessionIdCtrlList(uint16 instanceId, const Sd_RxQueueType* rxQueueItem, boolean isRxUseMulticast)
{
    ...
    if (!TCPIP_IS_IPADDR_ANY(remoteAddr))
    {
        ...
        if (NULL_PTR == sesIdCtrlPtr)
        {
            sesIdCtrlPtr = (Sd_SessionIdCtrlType*)Sd_MallocEx(sizeof(Sd_SessionIdCtrlType), Sd_RxMemPool);
            if (NULL_PTR != sesIdCtrlPtr)
            {
...
static void Sd_DeleteSessionIdNode(Sd_SessionIdCtrlType** head, const Sd_SessionIdCtrlType* objNode)
{
    Sd_SessionIdCtrlType *pNode = NULL_PTR, *qNode = NULL_PTR;
...
static void Sd_RemoteRebootDetectedHandle(uint16 instanceId, const Sd_RxQueueType* rxQueueItem)
{
    ...
    if (NULL_PTR != sesIdCtrlPtr)
    {
        ...
        while (NULL_PTR != serverServiceList)
        {
            for (index = 0u; index < serverServiceList->handleIdNum; index++)
            {
                Sd_RebootStopSubscribeEventHandle(serverServiceList->serviceHandleId[index], rxQueueItem);
            }
            serverServiceList = serverServiceList->next;
        }
#endif /* SD_EVENT_HANDLER_NUM > 0 */
    ...
    for (index = 0u; index < serverServicePtr->SdEventHandlerNum; index++)
    {
        ...
        while (NULL_PTR != subsMangPtr)
        {
            if ((subsMangPtr->sockRemoteAddr.addr[0] == rxQueueItem->remoteAddr.addr[0])
                && (subsMangPtr->sockRemoteAddr.port == rxQueueItem->remoteAddr.port))
            {
                /* Disable Routing Path*/
                eventHandlerTcpPtr = eventHandlerPtr->SdEventHandlerTcp;
                if ((NULL_PTR != eventHandlerTcpPtr) && (NULL_PTR != eventHandlerTcpPtr->SdEventActivationRef))
...
static Std_ReturnType Sd_OptionFormatCheck(const uint8 sdMsg[])
{
    uint32         entryArrayLen, optionArrayLen;
    uint32         index;
    uint32         firstOptionIndex;
    uint16         optionLength;
    Std_ReturnType optCheckRet;
    Std_ReturnType ret       = E_OK;
    uint32         headerLen = SD_HEADER_LEN + SD_MESSAGE_ENTRYLEN_FILED_LEN + SD_MESSAGE_OPTIONLEN_FILED_LEN;
    uint32         optionLenFieldOffset = 0u;

    entryArrayLen = Sd_NPtrtoHl(&sdMsg[SD_ENTRIES_ARRAY_LENGTH_INDEX]);
    if (0x00u != (entryArrayLen & SD_16_BYTE_ALIGNED_FRACTION)) /* entryArrayLen must aligned with 16 */
    {
        ret = E_NOT_OK;
    }
    else
    {
        ...
        optionLenFieldOffset = SD_MESSAGE_IPV4_OPTION_LEN + SD_MESSAGE_ENTRYLEN_FILED_LEN + entryArrayLen;
        optionArrayLen       = Sd_NPtrtoHl(&sdMsg[optionLenFieldOffset]);
        if (optionArrayLen > 0u)
        {
            /* 1st option index = SD_FIRST_ENTRY_INDEX(16) + entryArrayLen + SD_LENGTH_OF_OPTIONS_ARRAY_FIELD_LEN(4)*/
            firstOptionIndex = headerLen + entryArrayLen;
            index            = firstOptionIndex;
...
static void Sd_IfSpecificRoutingGroupTransmit(void)
{
    ...
    for (index = 0u; index < SD_EVENT_HANDLER_NUM; index++)
    {
        Sd_EventHandlerRTType* ehRTDataPtr = &Sd_EventHandlerRTData[index];
