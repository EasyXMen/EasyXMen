...
/**
  ...
  RuleSource:puhua-rule.rcf 3.0.0
    ...
    \li VL_MTR_SoAd_STMIF
      Reason: Functions have different scenarios that need to be covered, which depends on the configuration,
              as well as some precompiled macros
