 ...
 *  V2.1.24      2025-12-24  xue.han      CPT-16401,fix FF_DL overflow risk
 *               2026-01-26  li.feng      CPTASK-269,Issues identified during the code review for Yanfeng
 *               2026-02-27  xue.han      CPT-18049, Fix handling of STmin and N_Cs timers.
 *  V2.1.25      2026-03-12  xue.han      CPT-18154, Fix unexpected flow control response for incorrect FF_Dl.
 */
/*============================================================================*/
...
#define CANTP_SW_PATCH_VERSION         25U
