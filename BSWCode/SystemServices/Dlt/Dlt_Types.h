...
typedef struct
{
    ...
    P2CONST(Dlt_LogLevelThesholdType, AUTOMATIC, DLT_APPL_CONST) LogLevelThreshold;
...
typedef struct
{
    ...
    P2CONST(Dlt_TxPduType, AUTOMATIC, DLT_APPL_CONST) pDltTxPdu;
} Dlt_LogChannelType;
...
{
    uint16 ChannelNum;
    P2CONST(Dlt_LogChannelType, AUTOMATIC, DLT_APPL_CONST) pLogChannel;
    uint16 LogChannelAssignmentNum;
    P2CONST(Dlt_LogChannelAssignmentType, AUTOMATIC, DLT_APPL_CONST) pLogChannelAssignment;
...
typedef struct
{
    ...
    P2CONST(Dlt_EcuIdTypes, AUTOMATIC, DLT_APPL_CONST) pDltEcuId;
} Dlt_ProtocolType;
...
typedef struct
{
    ...
    P2CONST(Dlt_TraceStatusAssignmentTypes, AUTOMATIC, DLT_APPL_CONST) TraceStatusAssignment;
} Dlt_TraceStatusSettingType;

typedef struct
{
    P2CONST(Dlt_LogLevelSettingType, AUTOMATIC, DLT_APPL_CONST) pLogLevelSetting;
    P2CONST(Dlt_LogOutputType, AUTOMATIC, DLT_APPL_CONST) LogOutput;
    P2CONST(Dlt_ProtocolType, AUTOMATIC, DLT_APPL_CONST) Protocol;
    uint16 RxPduNum;
    P2CONST(Dlt_RxPduType, AUTOMATIC, DLT_APPL_CONST) pDltRxPdu;
    P2CONST(Dlt_TraceStatusSettingType, AUTOMATIC, DLT_APPL_CONST) pTraceStatusSetting;
} Dlt_ConfigType;
...
typedef struct
{
    ...
    P2CONST(Dlt_SwcContextType, AUTOMATIC, DLT_APPL_CONST) pDltSwcContext;
} Dlt_SwcTypes;
