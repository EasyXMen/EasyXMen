 ...
 * Sync/Async          Synchronous
 * Reentrancy          Non Reentrant
 * Param-Name[in]      IndicatorState
 * Return              uint8
 */
/*************************************************************************/
static inline uint8 Dem_J1939LampStatus(uint8 IndicatorState)
{
    uint8 ret;
 ...
 */
static inline uint8 Dem_J1939FlashLampStatus(uint8 IndicatorState)
{
    uint8 ret;
    switch (IndicatorState)
    {
