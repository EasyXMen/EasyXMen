...
/* PRQA S 1520, 1296 EOF */ /* VL_EcuM_1520, VL_EcuM_1296 */
...
#include "EcuM_MemMap.h"
static VAR(TaskType, ECUM_CLEARED) EcuM_McShutdownTaskId; /* PRQA S 3218 */ /* VL_EcuM_3218 */
...
#include "EcuM_MemMap.h"
volatile VAR(boolean, ECUM_CLEARED) EcuM_ShutdownFlag; /* PRQA S 3218 */ /* VL_EcuM_3218 */
#define ECUM_STOP_SEC_VAR_CLEARED_SHARE_BOOLEAN
#include "EcuM_MemMap.h"

#define ECUM_START_SEC_VAR_CLEARED_SHARE_BOOLEAN
#include "EcuM_MemMap.h"
static VAR(uint32, ECUM_CLEARED) EcuM_SlaveShutdownEvent; /* PRQA S 3218 */ /* VL_EcuM_3218 */
#define ECUM_STOP_SEC_VAR_CLEARED_SHARE_BOOLEAN
#include "EcuM_MemMap.h"
#endif /*ECUM_MAX_MCU_CORE_NUM > 1*/
/*******************************************************************************
...
EcuM_OffPreOS(void)
{
    ...
    else /*Slave core.*/
    {
        ...
        if (ECUM_MAX_MCU_CORE_NUM != slaveIdx)
        {
            ...
            /* PRQA S 4391 ++ */ /* VL_EcuM_DataConverteToWider */
            EcuM_SlaveShutdownEvent |= (uint32)(1u << slaveIdx);
            /* PRQA S 4391 -- */
        }
    }
