...
/**
  ...
  RuleSorce:puhua-rule.rcf 2.3.1
    ...
    \li VL_EcuM_1296
      Reason: Integer to enum conversion is intended and safe.
      Risk: No risk.
      Prevention: Functional reliability guaranteed by design.

    \li VL_EcuM_DataConverteToWider
      Reason:Data conversion to a wider range is necessary for accumulation.
      Risk:No risk.
      Prevention:None.

    \li VL_EcuM_RedundantCode
      Reason: The code is generated by the tool,The architecture needs to be revised, which will have a significant
  impact. Risk: Code redundancy and may difficult to maintain. Prevention: Code inspection and test of the different
  configurations in the component test.
