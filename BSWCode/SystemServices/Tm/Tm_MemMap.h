...
********************************************************************************
**                                                                            **
**  FILENAME    : Tm_MemMap.h                                               **
**                                                                            **
**  Created on  :                                                             **
**  Author      : <Auto generated>                                            **
**  Vendor      :                                                             **
**  DESCRIPTION : Memory mapping abstraction declaration of Tm              **
**                                                                            **
...
#else
#error "Tm_MemMap.h, section is used consecutively many times."
#endif
#define TM_START_SEC_CODE_NO_MATCH
#define START_SEC_CODE

#elif defined TM_STOP_SEC_CODE
#undef TM_STOP_SEC_CODE
#undef MEMMAP_ERROR
#ifdef TM_START_SEC_CODE_NO_MATCH
#undef TM_START_SEC_CODE_NO_MATCH
#else
#error "Tm_MemMap.h, no matching section was used."
#endif
...
#error "Tm_MemMap.h, wrong pragma command"
#endif
