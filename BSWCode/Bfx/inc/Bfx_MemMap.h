...
**  Vendor      :                                                             **
**  DESCRIPTION : Memory mapping abstraction declaration of Bfx              **
**                                                                            **
...
#else
#error "Bfx_MemMap.h, section is used consecutively many times."
#endif
#define BFX_START_SEC_CODE_NO_MATCH
#define START_SEC_CODE

#elif defined BFX_STOP_SEC_CODE
#undef BFX_STOP_SEC_CODE
#undef MEMMAP_ERROR
#ifdef BFX_START_SEC_CODE_NO_MATCH
#undef BFX_START_SEC_CODE_NO_MATCH
#else
#error "Bfx_MemMap.h, no matching section was used."
#endif
