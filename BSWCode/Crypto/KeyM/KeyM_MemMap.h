...
**  Vendor      :                                                             **
**  DESCRIPTION : Memory mapping abstraction declaration of KeyM              **
**                                                                            **
...
#else
#error "KeyM_MemMap.h, section is used consecutively many times."
#endif
#define KEYM_START_SEC_CODE_NO_MATCH
#define START_SEC_CODE

#elif defined KEYM_STOP_SEC_CODE
#undef KEYM_STOP_SEC_CODE
#undef MEMMAP_ERROR
#ifdef KEYM_START_SEC_CODE_NO_MATCH
#undef KEYM_START_SEC_CODE_NO_MATCH
#else
#error "KeyM_MemMap.h, no matching section was used."
#endif
...
/*Index:1  Section name :VAR_CLEARED_8*/
...
#error "KeyM_MemMap.h, section is used consecutively many times."
#endif
#define KEYM_START_SEC_VAR_CLEARED_8_NO_MATCH
#define START_SEC_VAR_CLEARED_8

#elif defined KEYM_STOP_SEC_VAR_CLEARED_8
#undef KEYM_STOP_SEC_VAR_CLEARED_8
#undef MEMMAP_ERROR
#ifdef KEYM_START_SEC_VAR_CLEARED_8_NO_MATCH
#undef KEYM_START_SEC_VAR_CLEARED_8_NO_MATCH
#else
#error "KeyM_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "KeyM_MemMap.h, section is used consecutively many times."
#endif
#define KEYM_START_SEC_VAR_CLEARED_BOOLEAN_NO_MATCH
...
#undef MEMMAP_ERROR
#ifdef KEYM_START_SEC_VAR_CLEARED_BOOLEAN_NO_MATCH
#undef KEYM_START_SEC_VAR_CLEARED_BOOLEAN_NO_MATCH
#else
#error "KeyM_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "KeyM_MemMap.h, section is used consecutively many times."
#endif
#define KEYM_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
...
#undef MEMMAP_ERROR
#ifdef KEYM_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
#undef KEYM_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
#else
#error "KeyM_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "KeyM_MemMap.h, section is used consecutively many times."
#endif
#define KEYM_START_SEC_CONST_UNSPECIFIED_NO_MATCH
#define START_SEC_CONST_UNSPECIFIED

#elif defined KEYM_STOP_SEC_CONST_UNSPECIFIED
#undef KEYM_STOP_SEC_CONST_UNSPECIFIED
#undef MEMMAP_ERROR
#ifdef KEYM_START_SEC_CONST_UNSPECIFIED_NO_MATCH
#undef KEYM_START_SEC_CONST_UNSPECIFIED_NO_MATCH
#else
#error "KeyM_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
#error "KeyM_MemMap.h, section is used consecutively many times."
#endif
#define KEYM_START_SEC_VAR_INIT_8_NO_MATCH
#define START_SEC_VAR_INIT_8

#elif defined KEYM_STOP_SEC_VAR_INIT_8
#undef KEYM_STOP_SEC_VAR_INIT_8
#undef MEMMAP_ERROR
#ifdef KEYM_START_SEC_VAR_INIT_8_NO_MATCH
#undef KEYM_START_SEC_VAR_INIT_8_NO_MATCH
#else
#error "KeyM_MemMap.h, no matching section was used."
#endif
#ifdef MEMMAP_ERROR_SEC_NO_MATCH
