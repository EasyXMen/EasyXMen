    ...
    VAR(KeyM_CertificateIdType, AUTOMATIC) CertUpperId)
{
        ...
        || (KeyM_CertPCfg[CertId].certUpperHierRef->certId != CertUpperId))
    {
        ...
        KeyM_CertStatus[CertId]
        != KEYM_CERTIFICATE_PARSED_NOT_VALIDATED) /*PRQA S 2991,2995*/ /*VL_KeyM_2991,VL_KeyM_2995*/
    {
        /*SWS_KeyM_00028*/
        ret = E_NOT_OK;
    }
        ...
        else
        {
            ...
            else
            {
                ...
                do
                {
                    ...
                    /*PRQA S 0771 --*/ /*VL_KeyM_0771*/
                } while (!certUpperHierRef->selfSignedCert);
            }
        }
    }
    return ret;
...
/*PRQA S 6010,6020 ++*/ /*VL_MTR_KeyM_6010,VL_MTR_KeyM_6020*/
FUNC(Std_ReturnType, KEYM_CODE)
    ...
    uint8 tag)
{
    ...
    if (((cerE - *cerS) < KEYM_CONST_1) || (**cerS != tag)) /* PRQA S 1822 */ /* VL_KeyM_1822 */
    {
        ret = E_NOT_OK;
    }
    else
    ...
    P2VAR(uint32, AUTOMATIC, KEYM_APPL_DATA) cerLen)
{
    ...
    else /*length > 127*/
    {
        ...
        {
        case KEYM_CONST_1:
            if ((cerE - *cerS) < KEYM_CONST_2) /* PRQA S 1822 */ /* VL_KeyM_1822 */
            {
                ret = E_NOT_OK;
            }
            else
            ...
            break;
        case KEYM_CONST_2:
            if ((cerE - *cerS) < KEYM_CONST_3) /* PRQA S 1822 */ /* VL_KeyM_1822 */
            {
                ret = E_NOT_OK;
            }
            else
            ...
            break;
        case KEYM_CONST_3:
            if ((cerE - *cerS) < KEYM_CONST_4) /* PRQA S 1822 */ /* VL_KeyM_1822 */
            {
                ret = E_NOT_OK;
            }
            else
            ...
            break;
        case KEYM_CONST_4:
            if ((cerE - *cerS) < KEYM_CONST_5) /* PRQA S 1822 */ /* VL_KeyM_1822 */
            {
                ret = E_NOT_OK;
            }
            else
    ...
    *intVal = 0u;
    ...
    if ((ret == (Std_ReturnType)E_OK) && (len > 0u) && (len <= 4u) && ((**cerS & KEYM_LONG_FORMAT_MASK) == 0u))
    {
        *cerLen = len;
        ...
        while (len-- > 0u) /* PRQA S 3440 */ /* VL_KeyM_3440*/
        {
            *intVal = **cerS;
            (*cerS)++;
        }
    ...
    P2CONST(uint8, TYPEDEF, KEYM_CONST) cerE)
{
    ...
    if (((cerE - *cerS) < KEYM_CONST_1) || (**cerS != KEYM_CERT_ASN1_INTEGER)) /* PRQA S 1822 */ /* VL_KeyM_1822 */
    {
        ret = E_NOT_OK;
    }
    else
    ...
    P2VAR(KeyM_Asn1DesType, AUTOMATIC, KEYM_APPL_DATA) sigPar)
{
    ...
    if ((ret == (Std_ReturnType)E_OK) || ((temp_EndAddr - *cerS) < KEYM_CONST_1)) /* PRQA S 1822 */ /* VL_KeyM_1822 */
    {
        tag          = **cerS;
        temp_EndAddr = *cerS + cerLen;
    ...
    P2VAR(KeyM_Asn1DesType, TYPEDEF, KEYM_APPL_DATA) isuNameOid)
{
    ...
    if (ret == E_OK)
    {
        ...
        if ((temp_EndAddr - *cerS) < KEYM_CONST_1) /* PRQA S 1822 */ /* VL_KeyM_1822 */
        {
            ret = E_NOT_OK;
        }
        else
        {
            ...
            if (ret == E_OK)
            {
                ...
                *cerS += isuNameOid->len;
                ...
                if (((temp_EndAddr - *cerS)
                     < (uint8)KEYM_CONST_1) /* PRQA S 1822,1852 */ /* VL_KeyM_1822,VL_KeyM_1852 */
    ...
    KeyM_CertCheckDate(P2CONST(KeyM_CertTimeType, AUTOMATIC, KEYM_APPL_DATA) time)
{
    ...
    KEYM_CHECK_RANGE(0u, mon, time->certMon); /* PRQA S 2996 */ /* VL_KeyM_2996 */
    return E_OK;
}
                        ...
                        if (ret == E_OK)
                        {
                            ...
                            if (ret == E_OK)
                            {
                                if ((KEYM_CONST_1 == timebitnum)
                                    && ('Z' == **cerS)) /* PRQA S 1881 */ /* VL_KeyM_1881 */
                                {
                                    (*cerS)++;
                                    timebitnum--;
                                }
    ...
    KeyM_CertEleStructType eleStrut)
{
    ...
    if ((cerE - *cerS) >= KEYM_CONST_1) /* PRQA S 1822 */ /* VL_KeyM_1822 */
    {
        timeTag = **cerS;
    ...
    P2CONST(uint8, TYPEDEF, KEYM_CONST) cerE)
{
    ...
    if (ret == E_OK)
    {
        ...
        if ((len % 0x08u) != 0u)
        {
            *cerS += 1; /*PRQA S 0489*/ /*VL_KeyM_0489*/
    ...
    KeyM_GetCertEle(KeyM_CertificateIdType certId, KeyM_CertEleStructType certEleStru)
{
    ...
    return certEleBuf; /*PRQA S 2963*/ /*VL_KeyM_2963*/
}
