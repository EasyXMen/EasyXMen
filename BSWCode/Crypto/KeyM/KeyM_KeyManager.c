...
#define KEYM_START_SEC_VAR_CLEARED_BOOLEAN
#include "KeyM_MemMap.h"
VAR(boolean, KEYM_VAR) KeyM_SessionOpen; /* PRQA S 1504*/ /* VL_QAC_OneRefSymbol */
#define KEYM_STOP_SEC_VAR_CLEARED_BOOLEAN
#include "KeyM_MemMap.h"
#endif
/*******************************************************************************
...
KeyM_Prepare(
    ...
    P2VAR(uint8, AUTOMATIC, KEYM_APPL_DATA) ResponseData,
    /* PRQA S 3673 --*/                                                            /* VL_QAC_3673 */
    P2VAR(uint16, AUTOMATIC, KEYM_APPL_DATA) ResponseDataLength) /* PRQA S 3673 */ /* VL_QAC_3673 */
{
    Std_ReturnType ret = E_NOT_OK;
