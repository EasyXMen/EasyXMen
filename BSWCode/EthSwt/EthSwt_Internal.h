...
/**
 * @brief     Switch mirror store type.
 */
typedef struct EthSwt_MirrorStoreTypeTag
{
    EthSwt_PortMirrorStateType mirroState; /**< mirror state. */
    EthSwt_PortMirrorCfgType*  MirrorInfo; /**< mirror infomation. */
} EthSwt_MirrorStoreType;

/**
 * @brief     Switch mirror shadow buffer type.
 */
typedef struct EthSwt_MirrorShadowBufTypeTag
{
    uint8                  swtIdx;          /**< switch index. */
    uint8                  mirroInnerState; /**< inner mirror state. */
    NvM_BlockIdType        blkId;           /**< block id. */
    EthSwt_MirrorStoreType MirrorStore;     /**< mirror store. */
} EthSwt_MirrorShadowBufType;

/**
 * @brief     Switch ARL table buffer type.
 */
typedef struct EthSwt_ArlTableBufTypeTag
{
    NvM_BlockIdType      blkId;                    /**< blocke id. */
